...
const solutions: Solution[] = [{
  ...
  highlights: ["Minibagger 1t - 2,7t (Diesel)", "Baumstumpffräse & Häcksler", "Rüttelplatten & Stampfer", "Anhänger für Grünschnitt & Material"],
  ...
  highlights: ["Minibagger 1t - 2,7t mit Anbaugeräten", "Elektro-Dumper für leisen Materialtransport", "Grabenräumlöffel & Tieflöffel", "Baumaschinenanhänger 1,8t - 3,5t", "Verkehrssicherung & Absperrung"],
  ...
  highlights: ["Scherenbühnen bis 12m Höhe", "Rollgerüste bis 11m", "Abbruchhammer & Bohrhammer", "Bautrockner für die Trocknung"],
  ...
  highlights: ["PA-Systeme & Soundboks", "LED-Beleuchtung & Moving Heads", "Partyzelte 3x3m bis 6x12m", "Geschirr, Gläser & Besteck"],
  ...
  highlights: ["Planenanhänger S bis XXL", "Kofferanhänger abschließbar", "24/7 Self-Service-Miete", "Weekend-Tarif: 3 Tage zahlen, 1 Tag Preis"],
  ...
  highlights: ["Mauerschlitzfräse & Diamantbohrer", "Bosch Profi-Akkugeräte", "Stromerzeuger 2,8 - 100 kVA", "Rollgerüste & Leitern"],
  ...
  highlights: ["Vertikutierer & Häcksler", "Rüttelplatten für Pflasterarbeiten", "Anhänger für Grünschnitt", "Elektrowerkzeuge für Renovierung"],
  ...
  highlights: ["Hüpfburgen 2,8m bis 6m", "Hüpfburg mit Wasserrutsche", "Nebelmaschine & Seifenblasen", "Mobile Soundboks-Lautsprecher"],
...
function SolutionCard({
  ...
  return <Link to={`/loesungen/${solution.id}`}>
      <Card className="h-full group hover:shadow-lg transition-all duration-300 overflow-hidden border-2 hover:border-primary/20">
        ...
        <div className={`aspect-[16/10] bg-gradient-to-br ${solution.color} relative overflow-hidden`}>
          <img src={solution.image} alt={solution.title} className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-500" />
        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-1.5 mb-4">
            {solution.highlights.slice(0, 3).map((highlight, index) => <div key={index} className="flex items-center gap-2 text-sm">
      ...
      <section className="py-12 lg:py-20">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {solutions.map((solution, index) => <AnimatedSection key={solution.id} animation="fade-in-up" delay={index * 0.05}>
