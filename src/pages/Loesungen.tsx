...
const solutions: Solution[] = [
  ...
  },
  {
    ...
    description: "Professionelle Baumaschinen für anspruchsvolle Tiefbauprojekte. Unsere vollelektrischen Minibagger ermöglichen emissionsfreies Arbeiten auch in sensiblen Bereichen.",
    image: "/placeholder.svg",
    icon: Shovel,
    categories: ["erdbewegung", "verdichtung", "absperrtechnik", "werkzeuge"],
    highlights: [
      "Elektro-Minibagger für Innenräume",
