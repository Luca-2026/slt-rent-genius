...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      />
      <section className="relative z-20 bg-primary py-10 min-h-[calc(100svh-6.5rem)] flex items-center sm:py-16 sm:min-h-0 lg:py-0 lg:min-h-[calc(100svh-17rem)] lg:items-center">
