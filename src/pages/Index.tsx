...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      />
      <section className="relative z-20 bg-primary py-8 min-h-[calc(100svh-7rem)] flex items-center sm:py-12 md:py-14 md:min-h-[calc(100svh-12rem)] lg:py-0 lg:min-h-[calc(100svh-17rem)] lg:items-center">
