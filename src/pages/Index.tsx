...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      />
      <section className="relative z-20 bg-primary py-8 min-h-[calc(100svh-7rem)] flex items-center sm:py-12 md:py-16 md:min-h-[calc(100svh-14rem)] lg:py-0 lg:min-h-[calc(100svh-17rem)] lg:items-center">
