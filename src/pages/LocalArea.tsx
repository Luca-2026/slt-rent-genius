...
export default function LocalAreaPage() {
  ...
  const localFaqs = [
    ...
    { question: `Kann ich Geräte auch am Wochenende in ${area.name} mieten?`, answer: `Anhänger sind 24/7 per E-Mail-Code verfügbar. Für Minibagger, Werkzeuge und andere Geräte kontaktieren Sie uns – wir finden eine Lösung.` },
    ...
    { question: `Kann ich einen Minibagger in der Nähe von ${area.name} mieten?`, answer: `Ja! Am Standort ${location?.name || area.name} (${area.distance} km) vermieten wir Minibagger von 1t bis 6t. Lieferung direkt nach ${area.name} möglich.` },
