...
export default function CategoryProducts() {
  ...
  const categorySeoTexts: Record<string, string[]> = {
    ...
    "kabel-stromverteiler": [
      ...
      `Konkrete Preisbeispiele: Der Endverteilerschrank EV32 mit 22 kVA / 32 A startet bei 19 €/Tag brutto und ist ideal für Baustellen-Unterverteilung sowie Event-Stromverteilung mit gemischtem 400 V/230 V-Bedarf. Der Anschlussverteilerschrank 44 kVA mit Zählerfeld ist ab 39 €/Tag brutto verfügbar und wird typischerweise als Übergabepunkt für den vom Netzbetreiber gesetzten Baustromzähler eingesetzt. Für Großbaustellen und Festivals stehen der EV63 (44 kVA) und der HV125 (86 kVA, Zuleitung über 125 A CEE oder 10 mm² Kabelschuhe) bereit. Alle Verteiler sind stückgeprüft, mit allstromsensitivem FI Typ B ausgestattet und damit auch für Frequenzumrichter, E-Ladegeräte und Wechselrichter freigegeben.`,
    ...
    nutzfahrzeuge: location.id === "krefeld" ? [
      ...
      `Mietkonditionen Bonn: 3,5t Pritschenwagen ab 55 €/Tag brutto, MAN TGL 7,5t ab 75 €/Tag brutto. Inklusive 100 Frei-Kilometer pro Tag (Mehrkilometer 0,23 € bzw. 0,40 € brutto), Vollkasko mit 2.500 € Selbstbeteiligung und 1.000 € Kaution. Kraftstoff (Diesel, beim MAN zusätzlich AdBlue) wird bei nicht vollgetankter Rückgabe nachberechnet, Maut beim 7,5-Tonner per Einzelfahrtnachweis. Die Fahrzeuge sind selbstfahrend und werden direkt am Standort Bonn übergeben – keine Tieflader-Anlieferung nötig.`,
    ] : [
  ...
  const categoryFaqs: Record<string, { question: string; answer: string }[]> = {
    ...
    nutzfahrzeuge: [
      { question: `Welche Nutzfahrzeuge kann ich bei SLT Rental in ${location.name} mieten?`, answer: `Am Standort ${location.name} stehen zwei selbstfahrende Dreiseitenkipper auf Anfrage zur Verfügung: der 3,5t Pritschenwagen mit Doppelkabine (Opel Movano oder vergleichbar, 7 Sitze, 1.135 kg Nutzlast, AHK 2,5 t) ab 55 €/Tag brutto und der 7,5t MAN TGL 8.220 Dreiseitenkipper mit Meiller D205 Aufbau (220 PS, Automatik, Euro 6e) ab 75 €/Tag brutto.` },
      ...
      { question: `Wie sind Kraftstoff, Frei-Kilometer und Maut geregelt?`, answer: `Im Mietpreis sind 100 Frei-Kilometer pro Tag enthalten. Beim 3,5-Tonner werden Mehrkilometer mit 0,23 € brutto berechnet, beim MAN TGL mit 0,40 € brutto. Die Rückgabe erfolgt vollgetankt; nicht aufgefüllter Diesel wird mit 2,85 €/l (brutto bzw. netto je Fahrzeug) und beim MAN AdBlue mit 2,20 €/l brutto. nachberechnet. Für den 7,5t MAN TGL gilt seit dem 01.07.2024 die LKW-Maut – wir berechnen sie per Einzelfahrtnachweis weiter.` },
