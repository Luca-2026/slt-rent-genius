...
export default function CategoryProducts() {
  ...
  const categoryFaqs: Record<string, { question: string; answer: string }[]> = {
    ...
    nutzfahrzeuge: [
      ...
      { question: `Wie sind Kraftstoff, Frei-Kilometer und Maut geregelt?`, answer: `Im Mietpreis sind 100 Frei-Kilometer pro Tag enthalten. Beim 3,5-Tonner werden Mehrkilometer mit 0,23 € brutto berechnet, beim MAN TGL mit 0,40 € brutto. Die Rückgabe erfolgt vollgetankt; nicht aufgefüllter Diesel wird mit 2,85 €/l brutto und beim MAN AdBlue mit 1,85 €/l brutto nachberechnet. Für den 7,5t MAN TGL gilt seit dem 01.07.2024 die LKW-Maut – wir berechnen sie per Einzelfahrtnachweis weiter.` },
