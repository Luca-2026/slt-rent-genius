...
export const kbArticles: KBArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: "Lightbulb",
        heading: "Tipp",
        text: "Prüfen Sie vor der Fahrt die Beleuchtung (13- oder 7-polig) und die Ladungssicherung.",
      },
      {
        icon: "Lock",
        heading: "Anhänger wieder abstellen und sperren",
        items: [
          "Zum Abstellen einfach den Bügel reindrücken und einrasten lassen – kein Code nötig.",
          "Warten Sie auf den langen Piepton – danach ist der Anhänger automatisch wieder gesperrt.",
          "Stellen Sie den Anhänger innerhalb des Mietzeitraums auf dem markierten Platz am Standort ab.",
          "Nachdem der Anhänger auf ordnungsgemäßen Zustand überprüft wurde, erhalten Sie Rückgabebestätigung und Rechnung per E-Mail – spätestens 48 Stunden nach Rückgabe.",
        ],
      },
      {
        type: "warning",
  ...
  // Erdbewegung
  {
    ...
    productIds: ["bobcat-e10z", "xcmg-xe20e", "minibagger-2-7t", "bonn-bobcat-e10", "bonn-xcmg-xe20e", "bonn-minibagger-2-7t"],
    type: "sicherheit",
  ...
  {
    id: "scherenbuehne-zs0607-datenblatt",
    title: "7,8 m Scherenarbeitsbühne elektro (ZS0607) – Datenblatt",
    description: "Technisches Datenblatt zur elektrischen Scherenarbeitsbühne Zoomlion ZS0607AC-Li mit 7,80 m Arbeitshöhe, 230 kg Traglast und Non-Marking-Reifen.",
    categoryId: "arbeitsbuehnen",
    productIds: ["scherenbuehne-8m", "bonn-scherenbuehne-8m"],
    type: "anleitung",
    pdfUrl: "/manuals/datenblatt-scherenbuehne-zs0607.pdf",
    tags: ["scherenarbeitsbühne", "scherenbühne", "zoomlion", "zs0607", "datenblatt", "arbeitsbühne", "7,8m", "elektro"],
    updatedAt: "2026-07-30",
  },
  {
    id: "scherenbuehne-zs1012-datenblatt",
    title: "11,8 m Scherenarbeitsbühne elektro (ZS1012) – Datenblatt",
    description: "Technisches Datenblatt zur elektrischen Scherenarbeitsbühne Zoomlion ZS1012AC mit 11,80 m Arbeitshöhe, 350 kg Traglast und Plattformausschub.",
    categoryId: "arbeitsbuehnen",
    productIds: ["scherenbuehne-12m", "bonn-scherenbuehne-12m"],
    type: "anleitung",
    pdfUrl: "/manuals/datenblatt-scherenbuehne-zs1012.pdf",
    tags: ["scherenarbeitsbühne", "scherenbühne", "zoomlion", "zs1012", "datenblatt", "arbeitsbühne", "11,8m", "elektro"],
    updatedAt: "2026-07-30",
  },
  {
  ...
  // Leitern & Gerüste
  {
    ...
    title: "Krause Rollgerüst STABILO Serie 10 & 50 – Aufbau- & Verwendungsanleitung (PDF)",
    description: "Universelle Aufbau- und Verwendungsanleitung für alle KRAUSE Fahrgerüste STABILO Serie 10 und Serie 50 (alle Arbeitshöhen von 3,3 m bis 11,4 m): Sicherheitshinweise, Aufbauschema, GuardMatic-System und technische Daten.",
    ...
    tags: ["krause", "rollgerüst", "stabilo", "serie 10", "serie 50", "aufbau", "anleitung", "pdf", "fahrgerüst", "leitern-gerueste", "universell"],
