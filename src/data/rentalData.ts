...
import imgWinterdienstKramer1 from "@/assets/products/erdbewegung/winterdienst-set-kramer-5045-1.jpg";
import imgWinterdienstKramer2 from "@/assets/products/erdbewegung/winterdienst-set-kramer-5045-2.png";
import imgWinterdienstKramer3 from "@/assets/products/erdbewegung/winterdienst-set-kramer-5045-3.png";
import imgWinterdienstKramer4 from "@/assets/products/erdbewegung/winterdienst-set-kramer-5045-4.png";
...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    description: "Verlängerungskabel, Stromverteiler und Kabelbrücken für die sichere Stromversorgung Ihrer Veranstaltung oder Baustelle. Wir machen auch Baustrom und übernehmen sämtliche Anträge zum Festpreis.",
    icon: iconKabel,
  },
  {
...
const trailerProducts: Product[] = [
  ...
  { 
    ...
    description: "Ladefläche: 250 x 150 x 100 cm | Händische Kippfunktion (Handpumpe)",
  ...
  { 
    ...
    weightKg: 3500, 
    category: "plattform",
    tags: ["autotransport", "baumaschine", "gebremst", "zweiachser"], 
  ...
  },
  {
    ...
    sortOrder: 2,
    category: "plattform",
    tags: ["autotransport", "baumaschine", "laubgitter", "gebremst", "dreiachser", "kippbar"],
    specifications: {
      "Hersteller": "Temared",
      "Modellreihe": "Universal (kippbar)",
      "Ladeflächenmaß (L x B)": "590 x 214 cm",
  ...
  { 
    ...
    image: "/product-images/anhaenger/motorrad-3fach-750-1.jpg",
    images: ["/product-images/anhaenger/motorrad-3fach-750-1.jpg", "/product-images/anhaenger/motorrad-3fach-750-2.jpg", "/product-images/anhaenger/motorrad-3fach-750-3.jpg"], 
    weightKg: 750, 
    category: "motorrad",
...
const erdbewegungProductsUnsorted: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      "Motor": "Yanmar 4TNV86CT-PLY, turboaufgeladen",
      "Abgasnorm": "EU Stufe V / EPA Tier 4 Final",
      "Motorleistung (brutto)": "35,5 kW (48 PS) bei 2.400 min-1",
      "Löffelinhalt": "0,16 m³",
      "Max. Grabtiefe": "3.600 mm",
      "Max. Grabreichweite": "6.170 mm",
      "Max. Ausschütthöhe": "4.000 mm",
      "Heckschwenkradius": "980 mm",
      "Unterwagenbreite": "1.960 mm",
      "Transportlänge": "5.650 mm",
      "Laufwerk": "Gummiketten, 400 mm",
      "Zusatzkreis 1": "max. 75 l/min bei 20 MPa",
      "Zusatzkreis 2": "max. 37 l/min bei 20 MPa",
      "Fahrgeschwindigkeit": "4,2 / 2,4 km/h",
    },
    rentalNotes: [
      "Preis gilt für 8 Betriebsstunden/Tag. Mehrstunden werden gesondert berechnet.",
      "Zzgl. Verbrauch – Rückgabe mit vollem Tank. Diesel: brutto 2,85 €/l.",
  ...
  },
  {
    ...
    specifications: {
      ...
      "Abgasstufe": "EU Stage V",
      "Schaufelinhalt (Standardschaufel)": "0,45 m³",
      "Nutzlast (S=1,25)": "1.310 kg",
      "Kipplast (Standardschaufel)": "2.270 kg",
      "Fahrgeschwindigkeit": "0 – 20 km/h (optional 0 – 30 km/h)",
      "Tankinhalt Diesel": "56 l",
      "Schneeschild": "Adler – hydraulisch im Neigungswinkel verstellbar (Links-/Rechts-Schwenkung aus der Kabine)",
      "Salzstreuer": "Anbau-Salzstreuer (Heck) mit Bluetooth-/App-Steuerung – Streumenge, Streubreite und Vor-/Nachlauf per Smartphone aus der Kabine",
  ...
  },
  {
    ...
    modelName: "KDe550p",
    description: "Elektro-Raddumper mit 8-10h reiner Arbeitszeit | Nutzlast: 550 kg | 4x4 Allradantrieb | Kippwinkel 110°",
    specifications: {
      "Antriebsart": "Elektro Raddumper mit 8-10h reiner Arbeitszeit",
      "Kippwinkel": "110° (extra groß)",
      "Maschinengewicht": "318 kg",
      "max. Tragfähigkeit": "550 kg",
      "Innenmaß Pritsche (LxBxH)": "80 cm x 64 cm x 40 cm",
      "Gesamtbreite": "78 cm",
      "Gesamthöhe": "117 cm",
      "Geschwindigkeitsstufen": "3",
      "Kraftstoff": "Elektro",
      "Ladezeit von 0-100%": "ca. 7-8 h",
      "Antriebsmotoren": "2 x 1000 W",
    ...
    rentwareCode: { krefeld: "L62XBG", muelheim: "LKXBX6" },
    rentalNotes: [
...
const weinsbergCaraOne480QDK: Product = {
  ...
  images: [
    ...
    "/product-images/wohnwagen-camping/weinsberg-caraone-480-qdk-2.jpg",
    "/product-images/wohnwagen-camping/weinsberg-caraone-480-qdk-3.png",
    "/product-images/wohnwagen-camping/weinsberg-caraone-480-qdk-4.webp",
...
const manKipperMeillerD205: Product = {
  ...
  category: "kipper",
  image: "/product-images/man-tgl-8220-kipper-1.jpg",
  images: [
    "/product-images/man-tgl-8220-kipper-1.jpg",
    "/product-images/man-tgl-8220-kipper-2.jpg",
    "/product-images/man-tgl-8220-kipper-3.jpg",
    "/product-images/man-tgl-8220-kipper-4.jpg",
  ],
  pricePerDay: "ab 75 €",
  onRequest: true,
...
const pritschenkipper35t: Product = {
  ...
  pricePerDay: "ab 55 €",
  onRequest: true,
  tags: ["dreiseitenkipper", "kipper", "3,5-tonner", "pritschenwagen", "doppelkabine", "opel movano", "fuehrerschein-b", "auf anfrage"],
  specifications: {
    // Fahrzeugdaten
...
const nutzfahrzeugeProducts: Product[] = [manKipperMeillerD205, pritschenkipper35t];
