...
const trailerProducts: Product[] = [
  ...
  { 
    ...
    description: "Hersteller: Humbauer\nLadeflächenmaß: (LxBxH)200 x 108 x 30 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 650 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgKasten750, 
    images: [imgKasten750], 
    weightKg: 750, 
    category: "kasten",
  ...
  { 
    ...
    description: "Hersteller: Stema\nLadeflächenmaß: (LxBxH)200 x 108 x 100 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 630 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgPlanenS750, 
  ...
  { 
    ...
    description: "Hersteller: Humbauer\nLadeflächenmaß: (LxBxH)200 x 108 x 130 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 630 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgPlanenM750, 
  ...
  { 
    ...
    description: "Hersteller: Stema\nLadeflächenmaß: (LxBxH)200 x 108 x 160 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 630 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgPlanenL750, 
  ...
  { 
    ...
    description: "Marke / Hersteller: Temared\nLadeflächenmaß: (LxBxH)264 x 124 x 160 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 550 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Marke / Hersteller: Temared\nLadeflächenmaß: (LxBxH)300 x 150 x 180 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 600 kg\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Marke / Hersteller: Temared\nLadeflächenmaß: (LxBxH)300 x 150 x 190 cm\nGesamtgewicht: 1300 kg\nNutzlast: ca. 1005 kg\nBenötigter Führerschein: Klasse 3, BE oder B wenn der PKW weniger als 2150 kg z.GG hat\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1182 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgPlanen1300, 
  ...
  { 
    ...
    description: "Hersteller: Hulco\nLadeflächenmaß: (LxBxH)400 x 200 x 210 cm\nGesamtgewicht: 3500 kg\nNutzlast: ca. 2800 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Auffahrrampen\nAuch zum Transport von PKWs oder ähnliches geeignet. \nBenötigter Führerschein: Klasse 3 oder BE \nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 3182 Kg eingetragen haben \nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Ladeflächenmaß: (LxBxH)600 x 250 x 250 cm\nGesamtgewicht: 3500 kg\nNutzlast: ca. 2800 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Gardinen- Planensystem (Über volle Länge beladbar)\nBenötigter Führerschein: Klasse 3 oder BE \nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 3182 Kg eingetragen haben \nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgPlanen3500_1, 
    images: [imgPlanen3500_1, imgPlanen3500_2, imgPlanen3500_3, imgPlanen3500_4], 
    weightKg: 3500, 
    sortOrder: 8,
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)223 x 147 x 147cm\nGesamtgewicht 750 kg\nNutzlast 387 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nMit kippbarer Deichsel, für ein bequemeres Auffahren und den Transport von z.B. Quads, Motorrädern zu ermöglicht. (Kurbelhub und Rampen nicht bei allen Modellen verfügbar )\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)300 x 150 x 180 cm\nGesamtgewicht: 1500 kg\nNutzlast: ca. 955 kg\nBenötigter Führerschein: Klasse 3, BE oder B wenn der PKW weniger als 2000 kg z.GG hat.\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1364 kg eingetragen haben. \nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)300 x 155 x 185 cm\nGesamtgewicht: 2000 kg\nNutzlast: ca.1350 kg\nBenötigter Führerschein: Klasse 3 oder BE\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2455 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)350 x 168 x 25 cm\nGesamtgewicht: 3500 kg\nNutzlast: 2785 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: durchgehende Auffahrrampe\nBenötigter Führerschein: Klasse 3 oder BE \nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 3182 Kg eingetragen haben",
  ...
  { 
    ...
    description: "Hersteller: Pongratz\nTyp: L-PAT 300/16 G\nLadeflächenmaß: (LxBxH)301 x 165 x 17 cm\nGesamtgewicht: 1500 kg\nNutzlast: 1120 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: durchgehende Auffahrrampe\nBenötigter Führerschein: Klasse 3, BE oder B wenn der PKW weniger als 2000 kg z.GG hat\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1364 kg eingetragen haben.",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)452 x 205 cm\nGesamtgewicht: 2700 kg\nNutzlast: 2079 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Seilwinde (max. 1000 kg)& Rampen\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2455 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)469 x 210 cm\nGesamtgewicht: 2700 kg\nNutzlast: 1985 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Seilwinde (max. 1000 kg) & Kippfunktion für tiefergelegte Autos\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2455 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: 300 x 150 x 95 cm\nGesamtgewicht: 1500 kg\nNutzlast: ca. 11000 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: händische Kippfunktion\nBenötigter Führerschein: Klasse 3 oder BE\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2455 Kg eingetragen haben",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)312 x 155 x 40 cm\nGesamtgewicht: 2700 kg\nNutzlast: ca. 1990 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Auffahrrampen, elektrische Kippfunktion\nBenötigter Führerschein: Klasse 3 oder BE\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2455 Kg eingetragen haben",
  ...
  { 
    ...
    description: "Hersteller: Temared\nLadeflächenmaß: (LxBxH)512 x 211 cm\nGesamtgewicht: 3500 kg\nNutzlast: 2672 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: Seilwinde & Auffahrrampen\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 3182 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Marke: Temared\nLadeflächenmaß: (LxBxH)264 x 126 x 100 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 560 kg\nExtras: Laubgitteraufsatz\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 2500 Kg eingetragen haben",
  ...
  { 
    ...
    description: "Marke: Temared\nLadeflächenmaß: (LxBxH)255 x 151 x 100 cm\nGesamtgewicht: 1300 kg\nNutzlast: ca. 1000 kg\nExtras: Laubgitteraufsatz & Rampen\nBenötigter Führerschein: Klasse 3, BE oder B wenn der PKW weniger als 2150 kg z.GG hat\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1182 eingetragen haben",
  ...
  { 
    ...
    description: "Für den transport von 1 bis 3 Motorrädern\nMarke: Temared\nLadeflächenmaß: (LxBxH)220 x 131 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 606 kg\nExtras: Auffahrrampe inkl.\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1000 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
  ...
  { 
    ...
    description: "Motorradanhänger für bis zu 2 Motorräder.\nReifengröße: 15\"-21\"\nReifenbreite 90 bis 200 mm\nHersteller: Pongratz\nTyp: L-PAT 300/16 G\nLadeflächenmaß: (LxBxH)301 x 165 x 17 cm\nGesamtgewicht: 1500 kg\nNutzlast: 1120 kg\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nExtras: durchgehende Auffahrrampe\nBenötigter Führerschein: Klasse 3, BE oder B wenn der PKW weniger als 2000 kg z.GG hat\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1364 kg eingetragen haben.\nEinen zweiten Motorradständer können Sie bei Bedarf im nächsten Schritt dazu buchen.",
    image: imgAutotransport1500_1, 
    images: [imgAutotransport1500_1, imgAutotransport1500_2, imgAutotransport1500_3], 
    weightKg: 1500, 
    category: "motorrad",
  ...
  { 
    ...
    description: "Marke: Temared\nLadeflächenmaß: (LxBxH)150 x 106 x 70 cm\nGesamtgewicht: 750 kg\nNutzlast: ca. 640 kg\nExtras: Aluminiumdeckel mit Gepäckträger(abschliesbar)\nBenötigter Führerschein: B\nAnschluss Typ: 13 Pol (Adapter erhältlich)\nVoraussetzung 100 Km/h: Zugfahrzeug muss ein Leergewicht von 1000 Kg eingetragen haben\nAuslandsfahrt nur mit Auslandsfahrt Haftpflichterweiterung! (kann bei der Reservierung ausgewählt werden)",
    image: imgUrlaub750, 
    images: [imgUrlaub750], 
    weightKg: 750, 
    category: "urlaub",
...
const erdbewegungProductsUnsorted: Product[] = [
  {
    ...
    description: "Betriebsgewicht: 1176 kg\nGesamtbreite: 1100 mm einfahrbar auf 710 mm\nGesamthöhe: 2209 mm (Bügel einklappbar)\nLöffelklasse: MS01\nMesch. Schnellwechsler\nPS: 11\nKraftstoff: Diesel (16 l)\nAnbaugeräte & Schaufeln: Tieflöffel 30cm inkl. weiteres können Sie im 2. Schritt auswählen\ninkl. 8 Betriebsstunden/Tag, Mehrstunden werden mit netto 13,00€ pro Std. berechnet.\nzzgl. Verbrauch, Tankfüllung je Mietgerät - Rückgabe des Mietgeräts mit vollgetankten Tank vereinbart. Diesel wird mit brutto 2,45€/l berechnet.",
  ...
  },
  {
    ...
    description: "Betriebsgewicht: 1885 kg\nGesamtbreite: 1360 mm einfahrbar auf 980 mm\nGesamthöhe: 2299 mm\nLöffelklasse: MS01\nMesch. Schnellwechsler\nPS: 14\nKraftstoff: Diesel (19 l)\nAnbaugeräte & Schaufeln: Tieflöffel 30cm inkl. weiteres können Sie im 2. Schritt auswählen \ninkl. 8 Betriebsstunden/Tag, Mehrstunden werden mit netto 16,00€ pro Std. berechnet.\nzzgl. Verbrauch, Tankfüllung je Mietgerät - Rückgabe des Mietgeräts mit vollgetankten Tank vereinbart. Diesel wird mit brutto 2,45€/l berechnet.",
  ...
  },
  {
    ...
    description: "Betriebsgewicht: 2050kg\nGesamtbreite: 1300 mm einfahrbar auf 990 mm\nGesamthöhe: 2350 mm\nLöffelklasse: MS01\nMesch. Schnellwechsler\nPS: 15,8\nKraftstoff: Diesel (25 l)\nAnbaugeräte & Schaufeln: Tieflöffel 30cm inkl. weiteres können Sie im 2. Schritt auswählen \ninkl. 8 Betriebsstunden/Tag, Mehrstunden werden mit brutto 16,00€ pro Std. berechnet.\nzzgl. Verbrauch, Tankfüllung je Mietgerät - Rückgabe des Mietgeräts mit vollgetankten Tank vereinbart. Diesel wird mit brutto 2,45€/l berechnet.",
  ...
  },
  {
    ...
    description: "Betriebsgewicht: 2780 kg\nGesamtbreite: 1500 mm\nGesamthöhe: 2580 mm\nLöffelklasse: MS03\nPS: 21\nMesch. Schnellwechsler\nAnbaugeräte: Tieflöffel 300mm inklusive\nKraftstoff: Diesel (33 l)\ninkl. 8 Betriebsstunden/Tag, Mehrstunden werden mit netto 24,00€ pro Std. berechnet.\nzzgl. Verbrauch, Tankfüllung je Mietgerät - Rückgabe des Mietgeräts mit vollgetankten Tank vereinbart. Diesel wird mit brutto 2,45€/l berechnet.",
  ...
  },
  {
    ...
    modelName: "KDe550",
    description: "Elektro Raddumper mit 8-10h reiner Arbeitszeit\nextra großer Kippwinkel von 110°\nMaschinengewicht: 318 kg\nmax. Tragfähigkeit: 550 kg\nMuldengröße: 0,3 m³\nGesamtbreite: 78 cm\nGesamthöhe: 117 cm\nZwei Geschwindigkeitsstufen\nKraftstoff: Elektro\nLadezeit von 0-100%: ca. 7-8h\nAntriebsmotoren: 2x1000W\nLadegerät: integriert mit 5m Kabel (230V)\n1x LED Frontscheinwerfer\n1X LED Topscheinwerfer\ninkl. 8 Betriebsstunden/Tag, Mehrstunden werden mit netto 5,60€ pro Std. berechnet.\nzzgl. Verbrauch, Batteriefüllung je Mietgerät - Rückgabe des Mietgeräts mit vollgeladenen Akkus vereinbart. Eine Ladung wird mit brutto 10€ berechnet.",
