...
export const productSEOData: Record<string, ProductSEOData> = {
  ...
  "das-soundsystem-3500w": {
    ...
    seoTitle: "D.A.S. PA-Anlage 3500W RMS mieten – bis 250 Personen",
    metaDescription: "Große PA-Anlage mit 2× 18\" Subwoofer & 2× 12\" Top, 3500W RMS, Bluetooth, App-Steuerung. Für Hochzeiten & Events bis 250 Personen mieten.",
    h1: "D.A.S. Soundsystem 3500W RMS – bis zu 250 Personen mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Leistungsstarke PA-Anlage für bis zu 250 Personen", "Lieferumfang: Subwoofer, Tops, Distanzstangen & Powercon-Kabel", "Bluetooth-Streaming & Steuerung per DAS Audio App"],
    useCaseBau: "",
    useCaseEvent: "Komplett-Beschallung für Hochzeiten, Geburtstage, Firmenevents, Open-Air-Partys, DJ-Sets und Live-Musik – indoor wie outdoor. Dank zwei 18\"-Subwoofern liefert die Anlage druckvollen Tiefbass, die 12\"-Topteile sorgen für klare Mitten und Höhen.",
    useCasePrivat: "Auch für private Hochzeiten, Gartenpartys und größere Familienfeiern mit bis zu 250 Gästen geeignet – einfach per Bluetooth vom Smartphone bespielbar.",
    primaryKeywords: "D.A.S. Soundsystem mieten Krefeld, große PA-Anlage mieten Krefeld, Soundanlage Hochzeit mieten NRW, PA-Anlage 250 Personen mieten, Bluetooth PA Anlage mieten, DJ Anlage mit Subwoofer mieten Krefeld, DAS Audio Vantec mieten",
    is247: false,
    dailyPriceFrom: 90,
    faqs: [
      { q: "Aus welchen Komponenten besteht das D.A.S. Soundsystem 3500W?", a: "Das Set besteht aus 2× DAS Audio VANTEC-18A Aktiv-Subwoofern (18 Zoll), 2× DAS Audio VANTEC-12A Aktiv-Topteilen (12 Zoll), 2× Distanzstangen zwischen Subwoofer und Topteil, 2× Hybrid-Powercon-Linkkabel (3 m) zur einfachen Verkabelung sowie 2× XLR-Signalkabel (10 m). Alles, was du für eine professionelle Stereo-Beschallung brauchst, ist enthalten." },
      { q: "Für wie viele Personen reicht die Anlage?", a: "Die 3500W RMS Systemleistung ist auf Veranstaltungen mit bis zu ca. 250 Personen ausgelegt – ideal für Hochzeiten, Firmenfeiern, DJ-Partys und Open-Air-Events, bei denen ordentlich Bass gefragt ist." },
      ...
      { q: "Kann ich Musik per Bluetooth abspielen?", a: "Ja, die VANTEC-12A Topteile verfügen über einen integrierten Bluetooth-Empfänger. Du kannst direkt vom Smartphone, Tablet oder Laptop streamen – ein zusätzliches Mischpult ist nicht zwingend erforderlich." },
      ...
      { q: "Wie hoch ist das Gesamtgewicht?", a: "Das komplette System inklusive Kabeln, Distanzstangen und Zubehör wiegt ca. 130 kg. Für den Transport empfehlen wir einen Kombi, Transporter oder unseren Anhänger – auf Wunsch liefern wir die Anlage auch direkt zur Veranstaltung." },
    ],
  },
  "bonn-das-soundsystem-3500w": {
    excelName: "D.A.S. Soundsystem 3500W RMS – bis zu 250 Personen – Bonn",
    seoTitle: "D.A.S. PA-Anlage 3500W mieten Bonn – bis 250 Personen",
    metaDescription: "Große PA-Anlage 3500W RMS mit 2× 18\" Subwoofer & 2× 12\" Top in Bonn mieten. Bluetooth, DAS Audio App, bis 250 Personen – ideal für Hochzeit & Open-Air.",
    h1: "D.A.S. Soundsystem 3500W RMS – bis zu 250 Personen mieten in Bonn – Jetzt verfügbar bei SLT Rental",
    h2s: ["Große PA-Anlage für Bonn & das Rheinland", "Lieferumfang: Subwoofer, Tops, Distanzstangen & Powercon-Kabel", "Bluetooth-Streaming & Steuerung per DAS Audio App"],
    useCaseBau: "",
    useCaseEvent: "Komplett-Beschallung für Hochzeiten, Firmenevents, Open-Air-Partys und DJ-Sets in Bonn, Bad Godesberg, Beuel, Wachtberg, Königswinter, Bad Honnef, Sankt Augustin, im Rhein-Sieg-Kreis und im Ahrtal. Zwei 18\"-Subwoofer liefern druckvollen Tiefbass, die 12\"-Topteile sorgen für klare Mitten und Höhen.",
    useCasePrivat: "Auch für private Hochzeiten und größere Gartenfeste rund um Bonn geeignet – Bluetooth-Streaming direkt vom Smartphone.",
    primaryKeywords: "D.A.S. Soundsystem mieten Bonn, große PA-Anlage mieten Bonn, Soundanlage Hochzeit mieten Rhein-Sieg, PA-Anlage 250 Personen mieten Bonn, DJ Anlage mit Subwoofer mieten Bonn, DAS Audio Vantec mieten Bonn",
    is247: false,
    dailyPriceFrom: 90,
    faqs: [
      { q: "Wo wird das D.A.S. Soundsystem in Bonn übergeben?", a: "Die Anlage disponieren wir auf Anfrage aus unserem Hauptsitz Krefeld und liefern sie direkt ins Bonner Stadtgebiet, nach Wachtberg, Königswinter, Bad Honnef, Sankt Augustin, in den Rhein-Sieg-Kreis oder ins Ahrtal. Anfahrt über A555, A565 und B9." },
      ...
      { q: "Für wie viele Personen reicht die Anlage?", a: "Die 3500W RMS Systemleistung ist auf Veranstaltungen mit bis zu ca. 250 Personen ausgelegt – ideal für Hochzeiten, Firmenfeiern und Open-Air-Events in Bonn und Umgebung." },
      { q: "Sind die Lautsprecher aktiv oder brauche ich eine Endstufe?", a: "Alle Komponenten sind aktiv – Subwoofer und Topteile haben eingebaute Endstufen samt DSP. Du brauchst nur 230 V Strom und eine Signalquelle." },
      ...
      { q: "Lässt sich die Anlage per App steuern?", a: "Ja. Mit der DAS Audio Aliante App (iOS/Android) kannst du EQ, Lautstärke, Crossover, Delay und Presets der VANTEC-Serie bequem vom Smartphone steuern." },
      { q: "Welche Presets stehen zur Verfügung?", a: "Werkseitige DSP-Presets der VANTEC-Serie, u.a. für Live-Musik, DJ/Playback, Sprache sowie verschiedene Crossover-Einstellungen für den Sub/Top-Betrieb." },
      { q: "Sind Distanzstangen und Verbindungskabel enthalten?", a: "Ja, 2× Distanzstangen und 2× Hybrid-Powercon-Linkkabel (Strom + Signal in einem Kabel) gehören zum Lieferumfang. Aufbau in wenigen Minuten." },
      { q: "Wie hoch ist das Gesamtgewicht?", a: "Das komplette System wiegt ca. 130 kg inkl. Kabeln und Zubehör. Auf Wunsch liefern wir die Anlage direkt zur Veranstaltung in Bonn und Umgebung." },
    ],
  },
  ...
  "soundsystem-2-1-1400w": {
    ...
    metaDescription: "2.1 PA-Anlage 1400W RMS mit integriertem 4-Kanal-Mischpult und Bluetooth-Empfänger in Krefeld mieten. 126 dB, bis 75 Personen – ideal für Hochzeit & Event.",
    h1: "2.1 Soundsystem 1400W RMS – mit Mischpult & Bluetooth-Empfänger mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Komplett-PA mit Bluetooth-Empfänger & 4-Kanal-Mischpult", "Lieferumfang: Stativ, Distanzstange & Kabelset", "Einsatz in Krefeld & im Umland"],
    useCaseBau: "",
    useCaseEvent: "Mobile DJ-Anlage für Hochzeiten, Geburtstage, Firmenfeiern, Konfirmationen, Schul- und Vereinsfeste in Krefeld und am Niederrhein – einfach per Bluetooth vom Smartphone bespielbar oder über das integrierte Mischpult mit Mikrofon, Instrument und Zuspieler kombinierbar.",
    useCasePrivat: "Auch für private Garten- und Hochzeitspartys in Krefeld, Meerbusch, Tönisvorst oder Willich geeignet – kompakt, schnell aufgebaut und mit ordentlich Druck für bis zu 75 Gäste.",
    primaryKeywords: "2.1 Soundsystem mieten Krefeld, PA-Anlage mit Mischpult mieten Krefeld, Bluetooth PA-Anlage mieten Krefeld, Musikanlage Hochzeit mieten Niederrhein, DJ-Anlage mieten Krefeld, 1400W PA mieten",
    is247: false,
    faqs: [
      ...
      { q: "Welche Anschlüsse bietet das integrierte Mischpult?", a: "Das integrierte 4-Kanal-Mischpult verfügt über XLR-, AUX- und Klinken-Eingänge. Damit lassen sich Mikrofone, Instrumente, Laptops oder DJ-Pulte gleichzeitig anschließen." },
      { q: "Für wie viele Personen reicht die Anlage?", a: "Mit 1400W RMS und bis zu 126 dB ist die Anlage für Veranstaltungen mit bis zu ca. 75 Personen ausgelegt – indoor wie outdoor." },
  ...
  "bonn-soundsystem-2-1-1400w": {
    ...
    metaDescription: "2.1 PA-Anlage 1400W RMS mit 4-Kanal-Mischpult und Bluetooth-Empfänger in Bonn mieten. 126 dB, bis 75 Personen – für Hochzeit, Geburtstag & Firmenevent.",
    h1: "2.1 Soundsystem 1400W RMS – mit Mischpult & Bluetooth-Empfänger mieten in Bonn – Jetzt verfügbar bei SLT Rental",
    h2s: ["Komplett-PA mit Bluetooth-Empfänger & 4-Kanal-Mischpult", "Abholung an unserer Filiale Bonn", "Einsatz im Rhein-Sieg-Kreis & Ahrtal"],
    useCaseBau: "",
    useCaseEvent: "Mobile PA-Anlage für Hochzeiten, Geburtstage, Firmenevents, Vereinsfeste und Outdoor-Partys im Bonner Stadtgebiet, in Bad Godesberg, Beuel, Wachtberg, Königswinter, Bad Honnef, Sankt Augustin und im Ahrtal. Per Bluetooth direkt vom Smartphone bespielbar.",
    useCasePrivat: "Ideal für private Garten- und Hochzeitspartys rund um Bonn – kompakt, schnell aufgebaut und mit integriertem Bluetooth-Empfänger für sofortiges Musik-Streaming.",
    primaryKeywords: "2.1 Soundsystem mieten Bonn, PA-Anlage mit Mischpult mieten Bonn, Bluetooth PA-Anlage mieten Bonn, Musikanlage Hochzeit mieten Bonn, DJ-Anlage mieten Bonn, PA-Anlage Rhein-Sieg-Kreis mieten",
    is247: false,
    faqs: [
      { q: "Wo kann ich das 2.1 Soundsystem in Bonn abholen?", a: "Die Anlage kannst du an unserer Filiale Bonn, Drachenburgstraße 8, 53179 Bonn (Bad Godesberg/Mehlem) abholen – Mo–Fr ab 07:00 Uhr und samstags durchgehend von 08:00 bis 17:30 Uhr." },
      { q: "Ist ein Bluetooth-Empfänger im Set enthalten?", a: "Ja, der Bluetooth-Empfänger ist im Lieferumfang enthalten. Du kannst direkt vom Smartphone oder Tablet kabellos Musik streamen." },
      { q: "Liefert ihr die Anlage auch ins Bonner Umland?", a: "Ja. Wir liefern auf Anfrage ins gesamte Bonner Stadtgebiet sowie nach Wachtberg, Königswinter, Bad Honnef, Sankt Augustin, in den Rhein-Sieg-Kreis und ins Ahrtal bis Bad Neuenahr-Ahrweiler. Anfahrt über A555, A565 und B9." },
      { q: "Für wie viele Personen reicht die Anlage?", a: "Mit 1400W RMS und bis zu 126 dB ist die Anlage für Veranstaltungen mit bis zu ca. 75 Personen ausgelegt – indoor wie outdoor." },
      { q: "Welche Anschlüsse bietet das integrierte Mischpult?", a: "Das integrierte 4-Kanal-Mischpult verfügt über XLR-, AUX- und Klinken-Eingänge. Damit kannst du Mikrofone, Instrumente, Laptops oder ein DJ-Pult anschließen." },
      ...
      { q: "Wie schwer ist die Anlage?", a: "Das Gesamtgewicht liegt bei ca. 55 kg. Die Anlage passt in jeden Kombi oder Transporter." },
    ],
  },
  "mh-soundsystem-2-1-1400w": {
    ...
    metaDescription: "2.1 PA-Anlage 1400W RMS mit 4-Kanal-Mischpult und Bluetooth-Empfänger in Mülheim an der Ruhr mieten. 126 dB, bis 75 Personen – für Events im Ruhrgebiet.",
    h1: "2.1 Soundsystem 1400W RMS – mit Mischpult & Bluetooth-Empfänger mieten in Mülheim an der Ruhr – Jetzt verfügbar bei SLT Rental",
    h2s: ["Komplett-PA mit Bluetooth-Empfänger & 4-Kanal-Mischpult", "Übergabe am Service-Standort Mülheim an der Ruhr", "Lieferung ins gesamte Ruhrgebiet"],
    useCaseBau: "",
    useCaseEvent: "Mobile PA-Anlage für Hochzeiten, Firmenfeiern, Vereinsfeste, Geburtstage und Outdoor-Partys in Mülheim an der Ruhr, Essen, Duisburg, Oberhausen, Bochum, Gelsenkirchen und Hattingen. Bluetooth-Empfänger inklusive – Musik direkt vom Smartphone streamen.",
    useCasePrivat: "Auch für private Gartenpartys und Hochzeiten im Ruhrgebiet geeignet – einsatzfertig, mit integriertem Mischpult für Mikrofon und Zuspieler.",
    primaryKeywords: "2.1 Soundsystem mieten Mülheim an der Ruhr, PA-Anlage mit Mischpult mieten Ruhrgebiet, Bluetooth PA-Anlage mieten Essen, Musikanlage Hochzeit mieten Mülheim, DJ-Anlage mieten Mülheim an der Ruhr",
    is247: false,
    faqs: [
      { q: "Wo kann ich das 2.1 Soundsystem in Mülheim an der Ruhr übernehmen?", a: "Die Übergabe erfolgt nach Terminvereinbarung an unserem Service-Standort Ruhrorter Str. 122, 45478 Mülheim an der Ruhr – eingebettet in die Bobcat-Filiale vor Ort. Anfahrt über A40 und A52." },
      ...
      { q: "Liefert ihr die Anlage auch ins übrige Ruhrgebiet?", a: "Ja. Wir liefern auf Anfrage nach Essen, Duisburg, Oberhausen, Mülheim, Bochum, Gelsenkirchen und Hattingen. Die Disposition erfolgt aus unserem Hauptsitz Krefeld, in der Regel am nächsten Werktag." },
      { q: "Für wie viele Personen reicht die Anlage?", a: "Mit 1400W RMS und bis zu 126 dB ist die Anlage für Veranstaltungen mit bis zu ca. 75 Personen ausgelegt – indoor wie outdoor." },
      { q: "Welche Anschlüsse bietet das integrierte Mischpult?", a: "Das integrierte 4-Kanal-Mischpult verfügt über XLR-, AUX- und Klinken-Eingänge für Mikrofone, Instrumente, Laptops oder DJ-Pult." },
      { q: "Brauche ich eine externe Endstufe?", a: "Nein, die Anlage ist vollständig aktiv – die Endstufe ist bereits integriert. Du brauchst nur 230 V Strom und eine Signalquelle." },
      { q: "Wie schwer ist die Anlage?", a: "Das Gesamtgewicht liegt bei ca. 55 kg. Die Anlage passt in jeden Kombi oder Transporter." },
    ],
  },
  ...
  "einhell-heissluftfoehn-te-ha18li": {
    excelName: "Akku Heißluftföhn",
    seoTitle: "Akku Heißluftföhn Einhell TE-HA 18Li mieten in Krefeld",
    metaDescription: "Akku-Heißluftgebläse Einhell TE-HA 18Li mieten in Krefeld. Kabelloses Arbeiten mit 18 V Power X-Change. Tagesmiete bei SLT Rental – jetzt buchen.",
    h1: "Akku Heißluftföhn mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten", "Einsatzbereiche", "Sicherheitshinweise"],
    useCaseBau: "Schrumpfschläuche aufschrumpfen, Farbe und Lack entfernen, Kunststoffe verformen, eingefrorene Leitungen auftauen oder Kleber lösen – ideal überall dort, wo keine Steckdose verfügbar ist.",
    useCaseEvent: "",
    useCasePrivat: "Aufkleber und Folien entfernen, Heißkleber aktivieren, Bastel- und Renovierungsarbeiten – kabellos und sofort einsatzbereit.",
    primaryKeywords: "Akku Heißluftföhn mieten in Krefeld, Einhell TE-HA 18Li mieten Krefeld, Heißluftgebläse leihen NRW",
    is247: false,
    faqs: [
      { q: "Brauche ich für den Einhell TE-HA 18Li eine Steckdose?", a: "Nein, das Gerät arbeitet kabellos mit dem Einhell Power X-Change 18 V Akku-System – ideal für Einsätze ohne Stromanschluss." },
      { q: "Ist ein Akku im Mietpreis enthalten?", a: "Ja, wir liefern das Gerät mit geladenem Power X-Change Akku und Ladegerät aus." },
      { q: "Wofür eignet sich ein Akku-Heißluftföhn?", a: "Typische Einsätze sind Schrumpfschläuche, Folien- und Aufkleberentfernung, Lack- und Farbentfernung, Auftauen von Leitungen sowie das Lösen von Klebeverbindungen." },
      { q: "Wie heiß wird das Gerät?", a: "Der TE-HA 18Li liefert je nach Stufe heiße Luft mit bis zu ca. 550 °C – dabei immer Sicherheitsabstand zu brennbaren Materialien einhalten." },
    ],
  },
  "akku-kettensaege-gke18v-40": {
    excelName: "Akku Kettensäge GKE 18V-40",
    seoTitle: "Akku Kettensäge Bosch GKE 18V-40 mieten in Krefeld",
    metaDescription: "Bosch Akku-Kettensäge GKE 18V-40 mit 40 cm Schwert mieten in Krefeld. Kabelloses, leises Arbeiten im Garten. Tagesmiete bei SLT Rental.",
    h1: "Akku Kettensäge GKE 18V-40 mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten", "Einsatzbereiche", "Sicherheit & Bedienung"],
    useCaseBau: "Zuschnitt von Bauholz und Kanthölzern, Rückbauarbeiten im Garten- und Landschaftsbau – flexibel ohne Kabel oder Benzin.",
    useCaseEvent: "",
    useCasePrivat: "Brennholz sägen, Äste und kleinere Bäume zurückschneiden, Sturmschäden beseitigen – ideal für Gartenarbeiten am Eigenheim.",
    primaryKeywords: "Akku Kettensäge mieten in Krefeld, Bosch GKE 18V-40 mieten Krefeld, Kettensäge leihen NRW",
    is247: false,
    faqs: [
      { q: "Welche Schwertlänge hat die Bosch GKE 18V-40?", a: "Die Kettensäge ist mit einem 40 cm Schwert ausgestattet und damit für die meisten Brennholz- und Gartenarbeiten geeignet." },
      { q: "Ist ein Akku im Mietpreis enthalten?", a: "Ja, das Gerät wird inklusive geladenem 18 V Akku und Ladegerät übergeben." },
      { q: "Brauche ich besondere Schutzausrüstung?", a: "Ja. Beim Sägen sind Schnittschutzhose, Sicherheitsschuhe, Helm mit Visier und Gehörschutz sowie Schnittschutzhandschuhe Pflicht. PSA ist nicht im Lieferumfang enthalten." },
      { q: "Wie lange hält eine Akkuladung?", a: "Je nach Holzart und Schnittstärke schafft eine Akkuladung typischerweise 30–80 Schnitte. Für längere Arbeiten empfehlen wir die Buchung eines Zweitakkus." },
      { q: "Ist Sägekettenöl enthalten?", a: "Eine Erstbefüllung Kettenöl ist im Mietpreis enthalten. Für längere Einsätze bitte zusätzliches Bio-Kettenöl bereithalten." },
    ],
  },
  "erdbohrer-benzin": {
    excelName: "Benzin-Erdbohrer",
    seoTitle: "Benzin-Erdbohrer mieten in Krefeld | Pfostenlöcher bohren",
    metaDescription: "Benzin-Erdbohrer / Motorerdbohrer mieten in Krefeld. Ideal für Zaunpfähle, Fundamente und Pflanzlöcher. Tagesmiete bei SLT Rental – jetzt buchen.",
    h1: "Benzin-Erdbohrer mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten", "Einsatzbereiche", "Tipps zur Anwendung"],
    useCaseBau: "Setzen von Zaunpfosten, Fundamenten für Carports und Schilder, Erdsondenbohrungen sowie Vorarbeiten im Garten- und Landschaftsbau.",
    useCaseEvent: "",
    useCasePrivat: "Zaun bauen, Wäschespinne setzen, Sichtschutz und Pergola fundamentieren oder Pflanzlöcher für Bäume und Sträucher bohren.",
    primaryKeywords: "Benzin-Erdbohrer mieten in Krefeld, Motorerdbohrer leihen Krefeld, Erdbohrgerät mieten NRW",
    is247: false,
    faqs: [
      { q: "Welche Bohrer (Schnecken) sind im Mietpreis enthalten?", a: "Standardmäßig ist eine Erdbohrschnecke enthalten. Weitere Durchmesser (z. B. 100, 150, 200 oder 300 mm) können nach Verfügbarkeit dazu gebucht werden – bitte bei der Anfrage angeben." },
      { q: "Eignet sich der Erdbohrer für steinigen Boden?", a: "Bei sandigen, lehmigen und normal bindigen Böden arbeitet der Bohrer zuverlässig. In stark steinigem oder sehr hartem Untergrund kann das Gerät blockieren – hier sind Voraushub oder ein Erdraketen-/Bagger-Einsatz sinnvoller." },
      { q: "Ist der Erdbohrer für eine oder zwei Personen?", a: "Wir empfehlen den Einsatz zu zweit. Das erhöht die Sicherheit beim Eindringen in härtere Schichten und beim plötzlichen Blockieren der Schnecke." },
      { q: "Welcher Kraftstoff wird benötigt?", a: "Der Erdbohrer läuft mit handelsüblichem Benzin (Super E5/E10). Eine Erstbetankung ist enthalten – Rückgabe bitte vollgetankt." },
      { q: "Brauche ich einen Anhänger für den Transport?", a: "Nein, der Erdbohrer passt zerlegt in jeden PKW-Kofferraum oder Kombi." },
    ],
  },
  "ms03-grabenraeumloeffel-140cm-symlock": {
    excelName: "MS03 Grabenräumlöffel starr 140cm/170l Symlock",
    seoTitle: "MS03 Grabenräumlöffel 140 cm Symlock mieten in Krefeld",
    metaDescription: "Starrer Grabenräumlöffel 140 cm / 170 l mit MS03 Symlock-Aufnahme mieten. Für Minibagger 2,5–3,5 t. Planieren, Profilieren, Räumen – bei SLT Rental.",
    h1: "MS03 Grabenräumlöffel starr 140cm/170l Symlock mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten", "Kompatible Bagger", "Einsatzbereiche"],
    useCaseBau: "Großflächige Planierarbeiten, Böschungen profilieren, Mutterboden abschieben, breite Gräben und Mulden räumen sowie Rasen- und Wegeflächen vorbereiten.",
    useCaseEvent: "",
    useCasePrivat: "",
    primaryKeywords: "MS03 Grabenräumlöffel 140 cm mieten Krefeld, Symlock Grabenräumlöffel mieten, Planierlöffel Minibagger leihen NRW",
    is247: false,
    faqs: [
      { q: "Für welche Bagger ist der MS03 Grabenräumlöffel 140 cm geeignet?", a: "Die MS03 Symlock-Aufnahme passt auf Minibagger der 2,5- bis 3,5-Tonnen-Klasse, z. B. XCMG XE27E und Bobcat E35z. Bei größeren Geräten (E50z) bitte vorab Aufnahme prüfen." },
      { q: "Welches Volumen und welche Arbeitsbreite hat der Löffel?", a: "Der Löffel hat 1.400 mm Arbeitsbreite, 170 l Volumen und wiegt ca. 129 kg." },
      { q: "Was ist der Unterschied zwischen starr und hydraulisch?", a: "Der starre Löffel ist fest mit dem Stiel verbunden und ideal für gerades Planieren. Hydraulische Schwenklöffel können seitlich geschwenkt werden – sinnvoll für Böschungen und Arbeiten ohne Umsetzen des Baggers." },
      { q: "Kann ich den Löffel zusammen mit einem Bagger mieten?", a: "Ja, wir empfehlen die kombinierte Buchung mit unseren passenden Minibaggern – inkl. Anlieferung auf Wunsch." },
    ],
  },
  "blanko-zusatzschild-42x23": {
    excelName: "Blanko-Zusatzschild, 42 x 23 cm",
    seoTitle: "Blanko-Zusatzschild 42 x 23 cm mieten in Krefeld",
    metaDescription: "Beschreibbares Blanko-Zusatzschild 42 x 23 cm für Halteverbots- und Verkehrsschilder. Individuell beschriftbar – bei SLT Rental in Krefeld mieten.",
    h1: "Blanko-Zusatzschild, 42 x 23 cm mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten", "Einsatzbereiche", "Kombination mit Verkehrsschildern"],
    useCaseBau: "Ergänzung zu Halteverbots-, Umleitungs- und Baustellenschildern – z. B. zur Angabe von Geltungsbereich, Datum, Uhrzeit oder individuellen Zusatzhinweisen.",
    useCaseEvent: "Individuelle Beschriftung für temporäre Halteverbotszonen bei Umzügen, Veranstaltungen, Filmproduktionen oder Lieferzonen.",
    useCasePrivat: "Privater Umzug oder Containerstellung – als Zusatzschild zu einem mobilen Halteverbot, beschriftbar mit Datum und Anlass.",
    primaryKeywords: "Blanko-Zusatzschild mieten Krefeld, Zusatzschild 42x23 cm leihen, Halteverbotsschild Zusatz mieten NRW",
    is247: false,
    faqs: [
      { q: "Welche Maße hat das Zusatzschild?", a: "Das Schild misst 42 × 23 cm und entspricht damit dem Standardformat für Zusatzzeichen unter Verkehrsschildern (z. B. VZ 286 / 283)." },
      { q: "Womit kann ich das Schild beschriften?", a: "Das Schild ist als Blanko-Schild ausgeführt und lässt sich mit handelsüblichen wasserfesten Markern oder vorbereiteten Aufklebern beschriften." },
      { q: "Brauche ich für ein Halteverbot eine Genehmigung?", a: "Ja. Für ein temporäres Halteverbot im öffentlichen Verkehrsraum ist eine verkehrsrechtliche Anordnung der Stadt erforderlich. Wir beraten dich gerne zum Ablauf." },
  ...
  "weinsberg-caraone-480-qdk": {
    ...
    faqs: [
      ...
      { q: "Sind Haustiere im Wohnwagen erlaubt?", a: "Hunde sind nach Absprache und gegen eine einmalige Hundepauschale von 79 € erlaubt (max. 1 Hund). Bitte gib in der Mietanfrage Größe und Anzahl deiner Tiere an, damit wir die Buchung entsprechend bestätigen können." },
      { q: "Wie ist der Wohnwagen versichert und wie hoch ist die Kaution?", a: "Unsere Wohnwagen sind Teil- und Vollkasko versichert. Die Selbstbeteiligung unsererseits gegenüber der Versicherung beträgt 2.500 €. Als Kaution ist von dir jedoch nur 1.000 € zu hinterlegen – diese wird nach unbeschädigter Rückgabe vollständig zurückerstattet." },
  ...
  "pritschenkipper-3-5t-dreiseitenkipper": {
    ...
    faqs: [
      ...
      { q: "Welche Kaution und Selbstbeteiligung gelten?", a: "Vor Übergabe wird eine Kaution von 1.000 € hinterlegt. Im Schadenfall greift die Vollkasko-Versicherung mit einer Selbstbeteiligung von 2.500 € pro Schaden." },
  ...
  "plattform-3500-absenkbar": {
    excelName: "3500 kg Plattformanhänger absenkbar (Temared Universal Tridem)",
    seoTitle: "3500 kg Plattformanhänger absenkbar mieten in Krefeld",
    metaDescription: "Temared Plattformanhänger 3.500 kg absenkbar mit Seilwinde & Auffahrrampen in Krefeld mieten. Ladefläche 512 x 211 cm, 2.672 kg Nutzlast – für Auto- und Baumaschinentransport. Ab 49 € / Tag.",
    h1: "3500 kg Plattformanhänger absenkbar mieten in Krefeld – mit Seilwinde & Auffahrrampen",
    h2s: [
      "Technische Daten Temared Plattformanhänger absenkbar",
      "Fahrzeugtransport: PKW, Oldtimer und Kleintransporter sicher verladen",
      "Baumaschinen transportieren: Minibagger, Radlader & Co. einfach beladen",
      "100 km/h-Zulassung, 13-Pol-Anschluss & Auslandsfahrt",
    ],
    useCaseBau: "Transport von Minibaggern bis ca. 2,6 t, Radladern, Stampfern, Rüttelplatten oder Bauwagen zur Baustelle. Dank absenkbarer Plattform und Auffahrrampen lassen sich Baumaschinen ohne Bühne oder Kran verladen, die Seilwinde hilft beim Verziehen nicht startbereiter Geräte.",
    useCaseEvent: "Transport von Bühnen-Trailern, Foodtruck-Anhängern oder schweren Event-Modulen bis 2.672 kg Nutzlast zwischen Lager und Veranstaltungsort.",
    useCasePrivat: "Transport eines liegengebliebenen PKWs, Oldtimer-Überführung zur Werkstatt oder TÜV, Umzug eines Quads, Rasentraktors oder kleinen Wohnwagens. Die abgesenkte Plattform reduziert den Auffahrwinkel deutlich und schützt tiefergelegte Fahrzeuge.",
    primaryKeywords: "Plattformanhänger absenkbar mieten Krefeld, Autotransporter absenkbar leihen Krefeld, 3500 kg Plattformanhänger mit Seilwinde mieten NRW",
    is247: false,
    dailyPriceFrom: 49,
    faqs: [
      { q: "Welche Fahrzeuge und Maschinen passen auf den Plattformanhänger?", a: "Bei einer Ladefläche von 512 x 211 cm und 2.672 kg Nutzlast eignet sich der Anhänger für die meisten PKW, Oldtimer, Kleintransporter, Quads sowie für Baumaschinen wie Minibagger bis ca. 2,6 t, Radlader, Stampfer und Rüttelplatten." },
      { q: "Wie funktioniert die absenkbare Plattform?", a: "Die Ladefläche kann hydraulisch bis zum Boden abgesenkt werden. Zusammen mit den mitgelieferten Auffahrrampen entsteht ein flacher Auffahrwinkel – ideal für tiefergelegte Fahrzeuge und Maschinen mit geringer Bodenfreiheit." },
      { q: "Ist eine Seilwinde dabei?", a: "Ja, eine Seilwinde gehört zur Standardausstattung. Damit lassen sich auch nicht fahrbereite Fahrzeuge sicher auf die Plattform ziehen." },
      { q: "Welcher Anschluss ist verbaut – 7 oder 13 polig?", a: "Der Anhänger hat serienmäßig einen 13-poligen Stecker. Ein Adapter auf 7-polig ist auf Anfrage kostenfrei erhältlich." },
      { q: "Darf ich 100 km/h auf der Autobahn fahren?", a: "Die 100 km/h-Zulassung ist möglich, wenn dein Zugfahrzeug ein eingetragenes Leergewicht von mindestens 3.182 kg aufweist. Bitte vor der Buchung den Fahrzeugschein prüfen." },
      { q: "Kann ich mit dem Anhänger ins Ausland fahren?", a: "Ja, Auslandsfahrten sind möglich – jedoch nur mit der Auslandsfahrt-Haftpflichterweiterung. Diese Option kannst du im Reservierungsprozess direkt mit auswählen." },
      { q: "Welcher Führerschein wird benötigt?", a: "Für die Kombination aus Zugfahrzeug und 3.500-kg-Anhänger ist in der Regel Klasse BE erforderlich. Mit Führerschein B96 sind Gespanne bis 4.250 kg zulässiges Gesamtgewicht möglich." },
    ],
  },
  "bonn-plattform-3500-absenkbar": {
    excelName: "3500 kg Plattformanhänger absenkbar – Bonn (auf Anfrage)",
    seoTitle: "3500 kg Plattformanhänger absenkbar mieten in Bonn – auf Anfrage",
    metaDescription: "Absenkbarer 3.500 kg Plattformanhänger (Temared Tridem, 512 x 211 cm) für Auto- und Baumaschinentransport in Bonn mieten – auf Anfrage, Lieferung aus dem Hauptsitz Krefeld. Ab 49 € / Tag.",
    h1: "3500 kg Plattformanhänger absenkbar mieten in Bonn – auf Anfrage",
    h2s: [
      "Auf Anfrage in Bonn – Lieferung aus dem Hauptsitz Krefeld",
      "Fahrzeugtransport in Bonn, Bad Godesberg & Königswinter",
      "Baumaschinentransport im Raum Bonn / Rhein-Sieg",
      "Technische Daten und Mietkonditionen",
    ],
    useCaseBau: "Transport von Minibaggern, Radladern und Verdichtungsgeräten zu Baustellen im Bonner Stadtgebiet, im Rhein-Sieg-Kreis und im Vorgebirge. Die absenkbare Plattform mit Seilwinde ist besonders praktisch in engen Innenstadt- und Hangbaustellen rund um Bad Godesberg, Königswinter und Bad Honnef.",
    useCaseEvent: "Transport von Bühnenmodulen, Foodtruck-Anhängern oder Generatoren zu Veranstaltungen am Rheinufer, in der Rheinaue oder im Kreis Ahrweiler.",
    useCasePrivat: "Überführung eines Unfall- oder Oldtimer-Fahrzeugs in eine Werkstatt im Raum Bonn, Umzug eines Quads, Rasentraktors oder kleinen Wohnwagens innerhalb von NRW und Rheinland-Pfalz.",
    primaryKeywords: "Plattformanhänger absenkbar mieten Bonn, Autotransporter absenkbar leihen Bonn, Baumaschinentransport Anhänger Bonn",
    is247: false,
    dailyPriceFrom: 49,
    faqs: [
      { q: "Ist der absenkbare Plattformanhänger in Bonn sofort verfügbar?", a: "Dieser Anhänger wird in Bonn ausschließlich auf Anfrage disponiert. Wir liefern ihn in der Regel innerhalb von 24 Stunden aus unserem Hauptsitz Krefeld an unsere Filiale Bonn – bei dringendem Bedarf häufig taggleich." },
      { q: "Wie reserviere ich den Anhänger für Bonn?", a: "Sende uns eine Anfrage mit Wunschtermin über das Anfrageformular oder rufe direkt in unserer Filiale Bonn an. Wir bestätigen Verfügbarkeit und Übergabezeitpunkt schriftlich." },
      { q: "Wo erfolgt Abholung und Rückgabe in Bonn?", a: "Übergabe und Rückgabe erfolgen an unserer Filiale Bonn (Drachenburgstraße 8, 53179 Bonn). Anhänger werden grundsätzlich vor Ort abgeholt – eine Lieferung des Anhängers selbst zum Kunden bieten wir nicht an." },
      { q: "Kann ich den Anhänger für Fahrzeug- und Baumaschinentransport gleichzeitig nutzen?", a: "Ja. Dank absenkbarer Plattform mit Seilwinde und Auffahrrampen ist der Anhänger gleichermaßen für PKW, Oldtimer und Kleintransporter wie auch für Minibagger, Radlader und Verdichtungsgeräte bis 2.672 kg Nutzlast geeignet." },
      { q: "Darf ich mit dem Anhänger ins benachbarte Ausland fahren?", a: "Ja, mit der zubuchbaren Auslandsfahrt-Haftpflichterweiterung. Diese Option wählst du im Reservierungsprozess aus. Ohne diese Erweiterung ist eine Auslandsfahrt nicht zulässig." },
      { q: "Welche Voraussetzung gilt für die 100 km/h-Zulassung?", a: "Dein Zugfahrzeug muss laut Fahrzeugschein ein Leergewicht von mindestens 3.182 kg aufweisen. Bitte prüfe das vor der Buchung." },
    ],
  },
  "muelheim-plattform-3500-absenkbar": {
    excelName: "3500 kg Plattformanhänger absenkbar – Mülheim an der Ruhr (auf Anfrage)",
    seoTitle: "3500 kg Plattformanhänger absenkbar mieten in Mülheim an der Ruhr",
    metaDescription: "Absenkbarer 3.500 kg Plattformanhänger (Temared Tridem) für Auto- und Baumaschinentransport in Mülheim an der Ruhr mieten – auf Anfrage, Übergabe am Service-Standort, Disposition aus Krefeld. Ab 49 € / Tag.",
    h1: "3500 kg Plattformanhänger absenkbar mieten in Mülheim an der Ruhr – auf Anfrage",
    h2s: [
      "Auf Anfrage in Mülheim an der Ruhr – Übergabe am Service-Standort",
      "Fahrzeugtransport im Ruhrgebiet: Mülheim, Essen, Oberhausen, Duisburg",
      "Baumaschinentransport für Hangbaustellen im Ruhrgebiet",
      "Technische Daten, Anschluss & Mietkonditionen",
    ],
    useCaseBau: "Transport von Minibaggern, Radladern und Verdichtungsgeräten zu Baustellen im Ruhrgebiet – insbesondere in den hügeligen Lagen rund um Mülheim-Saarn, Essen-Kettwig oder Oberhausen. Absenkbare Plattform und Seilwinde sparen Zeit beim Beladen ohne Rampenkonstruktion vor Ort.",
    useCaseEvent: "Anlieferung von Bühnen- oder Aggregat-Anhängern für Veranstaltungen im MüGa-Park, am Ruhrufer oder im Essener Grugapark.",
    useCasePrivat: "Überführung eines Unfall- oder Oldtimer-Fahrzeugs in eine Werkstatt im Ruhrgebiet, Transport eines Quads, kleinen Wohnwagens oder Aufsitz-Rasentraktors zu einem Ausflugs- oder Saisonziel.",
    primaryKeywords: "Plattformanhänger absenkbar mieten Mülheim an der Ruhr, Autotransporter absenkbar leihen Ruhrgebiet, Baumaschinentransport Anhänger Mülheim",
    is247: false,
    dailyPriceFrom: 49,
    faqs: [
      { q: "Ist der Anhänger in Mülheim an der Ruhr vor Ort verfügbar?", a: "Mülheim an der Ruhr ist unser Service-Standort. Diesen Plattformanhänger disponieren wir auf Anfrage aus unserem Hauptsitz Krefeld – in der Regel innerhalb von 24 Stunden. Übergabe, Einweisung und Rückgabe finden direkt an unserem Mülheimer Service-Standort statt." },
      { q: "Wie buche ich den Anhänger für einen Termin in Mülheim?", a: "Sende uns eine Anfrage mit Wunschtermin über das Formular oder kontaktiere unser Mülheim-Team telefonisch. Wir bestätigen Verfügbarkeit, Lieferung und Übergabezeitpunkt schriftlich." },
      { q: "Was kann ich mit dem absenkbaren Plattformanhänger transportieren?", a: "Bei 512 x 211 cm Ladefläche und 2.672 kg Nutzlast eignet sich der Anhänger für PKW, Oldtimer, Kleintransporter, Quads sowie Baumaschinen wie Minibagger bis ca. 2,6 t, Radlader und Verdichtungsgeräte." },
      { q: "Warum brauche ich die absenkbare Plattform für Baumaschinen?", a: "Die absenkbare Plattform mit Auffahrrampen reduziert den Auffahrwinkel deutlich. Maschinen mit geringer Bodenfreiheit, kurzen Ketten oder tiefergelegte Fahrzeuge lassen sich so sicher verladen, ohne aufzusetzen." },
      { q: "Ist die Auslandsfahrt-Versicherung für Fahrten in die Niederlande oder nach Belgien Pflicht?", a: "Ja. Für jede Auslandsfahrt ist die Auslandsfahrt-Haftpflichterweiterung zwingend notwendig. Du kannst sie bei der Reservierung als Zusatzoption mit auswählen." },
      { q: "Welcher Führerschein und welche Zugfahrzeug-Voraussetzung gelten?", a: "Für das Gespann ist in der Regel Klasse BE erforderlich (mit B96 bis 4.250 kg). Für die 100 km/h-Zulassung muss dein Zugfahrzeug laut Fahrzeugschein ein Leergewicht von mindestens 3.182 kg haben." },
    ],
  },
};
