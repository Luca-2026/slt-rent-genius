...
export const productSEOData: Record<string, ProductSEOData> = {
  ...
  "kompressor-1-2m3-stationaer": {
    ...
    seoTitle: "1,2 m³ Kompressor mieten Krefeld | Elektro 400 V Stationär",
    metaDescription: "Stationärer 1,2 m³ Elektro-Kompressor mieten in Krefeld. 7,5 kW Siemens-Motor, 400 V / 32 A, bis 13 bar. Ideal für Druckluftwerkzeuge & Erdraketen. Auf Anfrage.",
    h1: "1,2 m³ Kompressor (stationär) mieten in Krefeld – Auf Anfrage bei SLT Rental",
    h2s: ["Leistungsdaten 1,2 m³ / 7,5 kW", "Einsatzgebiete", "Stromanschluss & Sicherheit", "Anfrage & Verfügbarkeit"],
    useCaseBau: "Antrieb von Druckluftwerkzeugen, Erdraketen (45/65 mm) und Aufbruchhämmern an Standorten mit 400 V Drehstromanschluss – ideal für Hallen, Werkstätten und Innenstadt-Baustellen ohne Dieselemissionen.",
    useCaseEvent: "Pneumatische Bühnen-, Effekt- und Aufbau-Arbeiten in Locations mit Stromanschluss – emissionsfrei und mit geringem Schallpegel.",
    useCasePrivat: "Werkstattbetrieb von Druckluftwerkzeugen, Sandstrahlarbeiten an Fassaden, Karosserie- und Restaurationsarbeiten.",
    primaryKeywords: "1,2 m³ Kompressor mieten Krefeld, Elektro Kompressor mieten NRW, 400V Baukompressor mieten",
    is247: false,
    faqs: [
      { q: "Welcher Stromanschluss wird benötigt?", a: "Ein 400 V Drehstromanschluss mit 32 A Absicherung. Ohne diese Voraussetzungen kann der Kompressor nicht betrieben werden – bitte vor der Anmietung prüfen." },
      { q: "Wieviel Druck liefert der Kompressor?", a: "Bis zu 13 bar Betriebsdruck: 1,2 m³/min bei 7 bar, 1,0 m³/min bei 10 bar und 0,85 m³/min bei 13 bar." },
      { q: "Eignet er sich für Erdraketen?", a: "Ja – mit 1,2 m³/min bei 7 bar passt er ideal zur Erdrakete 45 mm und 65 mm. Für die 75 mm empfehlen wir unseren 2 m³ Bobcat-Kompressor." },
      { q: "Warum stationär statt mobil?", a: "Der Elektro-Kompressor ist leise, abgasfrei und ideal für Innenräume oder dauerhafte Druckluftversorgung. Für mobile Außeneinsätze ohne Stromanschluss nutzen Sie unseren Diesel-Kompressor." },
      { q: "Ist eine Kurzanleitung verfügbar?", a: "Ja, die Hersteller-Kurzanleitung von Kaeser ist direkt auf der Produktseite verlinkt." },
    ],
  },
