...
export const productSEOData: Record<string, ProductSEOData> = {
  ...
  "bosch-abbruchhammer-gsh16-28": {
    ...
    useCaseBau: "Aufbruch von Estrich, Mauerwerk und Betonwänden, Stemmarbeiten bei Sanierungen sowie Durchbrüche im Hochbau.",
    useCaseEvent: "",
    useCasePrivat: "Renovierung von Bädern, Entfernen alter Fliesen- und Estrichflächen, Aufbruch von Terrassenfundamenten im Garten.",
    ...
    faqs: [
      ...
      { q: "Wie schwer ist das Gerät und welcher Stromanschluss wird benötigt?", a: "Der Abbruchhammer wiegt 18,3 kg und wird über eine 230-V-Schuko-Steckdose betrieben (Nenneingangsleistung 1.750 W). Eine Standard-Baustellenversorgung reicht aus." },
  ...
  "weinsberg-caraone-480-qdk": {
    ...
    is247: false,
    faqs: [
      { q: "Was kostet es, den Weinsberg CaraOne 480 QDK bei SLT Rental zu mieten?", a: "Die Tagesmiete beginnt bei 50 € pro Tag. Hinzu kommt eine einmalige Servicepauschale von 99 €, die eine ausführliche Einweisung, eine 11 kg Gasflasche, Spiegelverlängerungen, Strom-Adapterkabel, Erstausstattung Sanitärchemie und 2 Rollen Toilettenpapier beinhaltet. Eine Kaution von 800 € wird ebenfalls fällig. Die Mindestmietdauer beträgt 5 Tage. Längere Mietzeiträume und Saisonpreise sind auf Anfrage möglich." },
      ...
      { q: "Was ist im Mietpreis enthalten und was kostet extra?", a: "Im Tagespreis enthalten sind die voll ausgestattete Küche und die Vollkaskoversicherung. Hinzu kommt eine einmalige Servicepauschale von 99 €, die eine ausführliche Einweisung, eine 11 kg Gasflasche, Spiegelverlängerungen, Strom-Adapterkabel, Erstausstattung Sanitärchemie und 2 Rollen Toilettenpapier beinhaltet. Optional buchbar sind Vorzelt, Campingtisch und -stühle, Fahrradträger und Sat-Anlage." },
