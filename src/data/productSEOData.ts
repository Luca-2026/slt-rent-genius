...
export const productSEOData: Record<string, ProductSEOData> = {
  ...
  "slt-eiswuerfelmaschine-profi-45kg": {
    seoTitle: "Eiswürfelmaschine mieten Krefeld – 45 kg/Tag Gastro | SLT",
    metaDescription: "Profi-Eiswürfelmaschine mieten in Krefeld & Bonn: 45 kg Eis pro 24 h, 28,4 l Vorratsbehälter, Edelstahl, Selbstreinigung. Für Gastronomie, Catering & Events.",
    h1: "Eiswürfelmaschine mieten in Krefeld – Profi-Gerät mit 45 kg pro Tag",
    h2s: [
      "Leistung & Kapazität: 45 kg Eis in 24 Stunden",
      "Wasseranschluss, Aufstellung und Abmessungen",
      "Einsatz in Gastronomie, Catering und auf Events",
      "Bedienung, Selbstreinigung & Hygiene",
    ],
    useCaseBau: "Kaltgetränke-Versorgung für Richtfeste, Baustellenübergaben und Mitarbeiterfeste – ein Gerät deckt den Eisbedarf eines ganzen Veranstaltungstages.",
    useCaseEvent: "Hochzeiten, Firmenfeiern, Sommerfeste, Cateringbetriebe, Bars, Restaurants, Cafés und Hotels. 45 Würfel je Zyklus versorgen mehrere Cocktail-Stationen gleichzeitig.",
    useCasePrivat: "Große Gartenpartys, Familienfeiern und Vereinsfeste, bei denen kompakte Tischgeräte nicht mehr ausreichen.",
    dailyPriceFrom: 19,
    faqs: [
      {
        q: "Wie viel Eis produziert die Profi-Eiswürfelmaschine pro Tag?",
        a: "Bis zu 45 kg Eiswürfel in 24 Stunden. Pro Zyklus entstehen 45 Würfel in 8 bis 18 Minuten – genug für Bars, Restaurants, Hotels und große Events.",
      },
      {
        q: "Wie groß ist der Vorratsbehälter?",
        a: "Der Behälter fasst 28,4 Liter und damit rund 15 kg Eiswürfel. Über das Sichtfenster siehst du den Füllstand jederzeit, ohne den Deckel zu öffnen.",
      },
      {
        q: "Braucht die Maschine einen Wasseranschluss?",
        a: "Ja. Das Gerät arbeitet mit einem industriellen Pumpenkreislauf und festem Wasseranschluss für den unterbrechungsfreien Betrieb. Zu- und Ablaufschlauch sind im Lieferumfang enthalten; am Aufstellort werden Wasseranschluss und Ablauf benötigt.",
      },
      {
        q: "Welche Abmessungen und welches Gewicht hat das Gerät?",
        a: "80 x 40 x 50 cm (H x B x T) bei 25,5 kg Eigengewicht. Das Netzkabel ist 1,8 m lang, die Standfüße sind höhenverstellbar. Transportiert wird die Maschine stehend, am besten zu zweit.",
      },
      {
        q: "Welche Stromversorgung wird benötigt?",
        a: "220–240 V bei 50/60 Hz über eine normale Schuko-Steckdose. Die Kompressorleistung beträgt 370 W, als Kältemittel kommt R290 zum Einsatz. Ein CEE-Anschluss oder Aggregat ist nicht nötig.",
      },
      {
        q: "Muss ich die Maschine manuell reinigen?",
        a: "Das Gerät hat eine automatische Selbstreinigungsfunktion, die den Kreislauf ohne Betriebsunterbrechung sauber hält. Zurückgegeben wird die Maschine entleert und grob gereinigt.",
      },
      {
        q: "Wie unterscheidet sich das Profi-Modell vom kompakten Eiswürfelbereiter?",
        a: "Das Profi-Modell mit 45 kg Tageskapazität, 28,4-l-Vorratsbehälter und festem Wasseranschluss ist für den gewerblichen Dauerbetrieb ausgelegt. Der kompakte SLT Eiswürfelbereiter ist die kleinere Variante für Hausbar, Büro und kleinere Feiern – ohne Wasseranschluss, aber mit deutlich geringerer Tageskapazität.",
      },
      {
  ...
  "minibagger-5t": {
    seoTitle: "5t Minibagger mieten – ab 135 €/Tag | SLT Rental",
    metaDescription: "5t Minibagger mieten bei SLT Rental in Krefeld, Bonn & Mülheim an der Ruhr: LiuGong 9057F ZTS, 48 PS, 3,6 m Grabtiefe, Null-Heckschwenk, 2 Zusatzkreise. Ab 135 €/Tag.",
    h1: "5t Minibagger mieten in Krefeld – Jetzt verfügbar bei SLT Rental",
    h2s: ["Technische Daten des 5t Minibaggers", "Hydraulik und Zusatzkreise", "Transport und Einsatzbereiche"],
    dailyPriceFrom: 135,
    useCaseBau: "Baugruben, Kanal- und Leitungsgräben, Fundamente und Rückbau: Mit 3.600 mm Grabtiefe, 6.170 mm Grabreichweite, 44 kN Löffelreißkraft und zwei Zusatzhydraulikkreisen (75 bzw. 37 l/min) arbeitet der 5t Minibagger auch mit Hydraulikhammer oder Sortiergreifer – dank Null-Heckschwenk (980 mm) auch direkt an der Wand.",
    useCaseEvent: "",
    useCasePrivat: "Für größere Aushubarbeiten auf dem eigenen Grundstück – Poolgrube, Keller, Drainage oder Geländemodellierung – bringt der 5t Minibagger 3,6 m Grabtiefe und 4,0 m Ausschütthöhe mit. Die 400 mm breiten Gummiketten schonen befestigte Flächen; für den Transport ist ein zugelassener Tieflader nötig.",
    faqs: [
      { q: "Welches Modell ist der 5t Minibagger?", a: "Wir vermieten den LiuGong 9057F ZTS mit 5.700 kg typischem Betriebsgewicht, Yanmar-Turbodiesel mit 35,5 kW (48 PS) nach EU Stufe V und Null-Heckschwenk." },
      { q: "Wie tief und wie weit kann der 5t Minibagger graben?", a: "Die maximale Grabtiefe beträgt 3.600 mm, die maximale Grabreichweite 6.170 mm und die maximale Ausschütthöhe 4.000 mm." },
      ...
      { q: "Wie breit ist der 5t Minibagger?", a: "Die Unterwagenbreite beträgt 1.960 mm, die Transportlänge 5.650 mm und die Transporthöhe über Ausleger 2.570 mm." },
      ...
      { q: "Was kostet die Miete des 5t Minibaggers?", a: "Die Miete startet ab 135 € netto pro Tag. Der finale Preis hängt von Standort, Mietdauer und Anbaugeräten ab." },
    ],
  },
