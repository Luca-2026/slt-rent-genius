...
export const localCategoryContent: LocalContentMap = {
  ...
  bonn: {
    ...
    "kabel-stromverteiler": {
      hookline:
        "Verlängerungskabel, Stromverteiler und Kabelbrücken für die sichere Stromversorgung Ihrer Veranstaltung oder Baustelle – an unserer Filiale Bonn abholbar, samstags bis 17:30 Uhr ohne Voranmeldung. Wir machen auch Baustrom und übernehmen sämtliche Anträge zum Festpreis.",
      standortFakten:
    ...
    nutzfahrzeuge: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: "Bei beiden Kippern sind 100 km/Tag im Mietpreis enthalten. Mehrkilometer kosten beim 7,5-Tonner 0,40 €/km brutto und beim 3,5-Tonner 0,23 €/km brutto. Die Rückgabe erfolgt vollgetankt mit Diesel (sonst 2,85 €/l brutto); beim 7,5-Tonner zusätzlich AdBlue vollgetankt (sonst 1,85 €/l brutto). Kaution 1.000 €, Vollkasko-Selbstbeteiligung 2.500 €.",
        },
      ],
    }
  },
  ...
  krefeld: {
    ...
    "kabel-stromverteiler": {
      hookline:
        "Verlängerungskabel, Stromverteiler und Kabelbrücken für die sichere Stromversorgung Ihrer Veranstaltung oder Baustelle – direkt am Hauptsitz Krefeld verfügbar. Wir machen auch Baustrom und übernehmen sämtliche Anträge zum Festpreis.",
      standortFakten:
  ...
  muelheim: {
    ...
    "kabel-stromverteiler": {
      hookline:
        "Verlängerungskabel, Stromverteiler und Kabelbrücken für die sichere Stromversorgung Ihrer Veranstaltung oder Baustelle – Übergabe an unserem Service-Standort Mülheim in der Bobcat-Filiale, Lieferung ins gesamte Ruhrgebiet. Wir machen auch Baustrom und übernehmen sämtliche Anträge zum Festpreis.",
      standortFakten:
