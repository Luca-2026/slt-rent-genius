// Allgemeine Geschäfts- und Vermietbedingungen für Verbraucher (B2C)
// Quelle: vom Mandanten gelieferte Word-Datei, Stand Mai 2026.

import type { LegalSection } from "./agb-b2b";

export const AGB_B2C_META = {
  title: "Allgemeine Geschäfts- und Vermietbedingungen für Verbraucher (B2C)",
  subtitle:
    "der SLT Technology Group GmbH & Co. KG und der eingetragenen Marke SLT-Rental",
  stand: "Stand: Mai 2026",
};

export const AGB_B2C_SECTIONS: LegalSection[] = [
  {
    id: "i",
    number: "I.",
    ...
    subsections: [
      {
        ...
        body: [
          {
            type: "p",
            text: "Für sämtliche Mietverträge zwischen der SLT Technology Group GmbH & Co. KG („SLT“) und einem Verbraucher im Sinne von § 13 BGB (im Folgenden „Mieter“) gelten ausschließlich diese Allgemeinen Geschäfts- und Vermietbedingungen (im Folgenden „AGB“).",
          },
          {
            type: "p",
            text: "Verbraucher ist jede natürliche Person, die ein Rechtsgeschäft zu Zwecken abschließt, die überwiegend weder ihrer gewerblichen noch ihrer selbständigen beruflichen Tätigkeit zugerechnet werden können.",
          },
          {
            type: "p",
            text: "Für Unternehmer im Sinne von § 14 BGB gelten gesonderte Allgemeine Geschäfts- und Vermietbedingungen (B2B), die ebenfalls auf der Website www.slt-rental.de zum Abruf bereitstehen.",
          },
          {
            type: "p",
          ...
          {
            type: "p",
            text: "Sollten einzelne Bestimmungen dieser AGB unwirksam sein, berührt dies nicht die Wirksamkeit der übrigen Bestimmungen.",
          },
        ],
      },
    ],
  },
  {
    ...
    subsections: [
      ...
      },
      {
        id: "ii-2-2",
        number: "2.2",
        title: "Mietanfrage und Vertragsschluss",
        body: [
          {
            type: "p",
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "SLT ist berechtigt, vor Übergabe der Mietsache die Vorlage eines gültigen amtlichen Lichtbildausweises (Personalausweis oder Reisepass) zu verlangen. Bei Vermietung von Kraftfahrzeugen und Anhängern ist zusätzlich der Führerschein vorzulegen, dessen Vorlage durch Sichtkontrolle dokumentiert wird. Sofern aus dem vorgelegten Ausweisdokument (z.B. Reisepass, Aufenthaltstitel) die aktuelle Meldeanschrift nicht hervorgeht, kann SLT zusätzlich eine aktuelle Meldebescheinigung (nicht älter als drei Monate) verlangen.",
          },
          {
            type: "p",
            text: "Bei Online-Buchungen über den Webshop oder bei kontaktloser Übergabe gemäß Ziff. 3.1a ist der Mieter verpflichtet, die nach den vorstehenden Sätzen erforderlichen Dokumente (Lichtbildausweis, bei Kraftfahrzeugen und Anhängern zusätzlich Führerschein, ggf. Meldebescheinigung) bereits im Online-Buchungsprozess als digitale Kopie hochzuladen. Die Übermittlung erfolgt über eine verschlüsselte Verbindung. Ohne vollständige Übermittlung der erforderlichen Dokumente wird die Buchung nicht freigegeben bzw. der Zugangscode nicht versandt.",
          },
          {
            type: "p",
            text: "Die erhobenen Daten werden ausschließlich zur Identitäts- und Adressverifizierung verarbeitet und nach Beendigung des Mietverhältnisses gemäß den gesetzlichen Aufbewahrungsfristen gelöscht. Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b und lit. f DSGVO. Bei Nichtvorlage der erforderlichen Dokumente kann die Vermietung verweigert werden; ein Anspruch des Mieters auf Schadensersatz besteht in diesem Fall nicht.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Alle Preise verstehen sich als Brutto-Endpreise inklusive der gesetzlich geltenden Mehrwertsteuer.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Die Rückzahlung der Kaution erfolgt innerhalb von zehn Werktagen nach ordnungsgemäßer Rückgabe und Prüfung des Mietgegenstandes. Bei kontaktloser Rückgabe von Anhängern gemäß Ziff. 3.1a erfolgt die Schadens- und Vollständigkeitsprüfung durch einen Mitarbeiter von SLT innerhalb von 48 Stunden nach dem vereinbarten Mietende; die Frist zur Rückzahlung der Kaution beginnt mit dem Abschluss dieser Prüfung. Stellt SLT bei der Prüfung Schäden oder Fehlbestände fest, wird der Mieter hierüber in Textform informiert.",
          },
          {
            type: "p",
            text: "SLT ist berechtigt, mit unstreitigen oder rechtskräftig festgestellten Forderungen aus dem Mietverhältnis (insbesondere Mietforderungen und Schadensersatzansprüchen wegen Beschädigung oder Verlust der Mietsache) gegen die Kaution aufzurechnen. Streitige Forderungen werden bis zur Klärung von der Kaution einbehalten; die Klärung soll innerhalb von sechs Monaten nach Rückgabe erfolgen.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Sofern ein Hin- und Rücktransport beauftragt wurde, setzt SLT eine frei befahrbare und zugängliche Übergabestelle voraus. Sollte es zu Verzögerungen kommen, die nicht durch SLT zu vertreten sind (z.B. fehlende Zugänglichkeit, Wartezeiten), behält sich SLT vor, diese in Rechnung zu stellen. Teilabholungen werden gesondert in Rechnung gestellt.",
          },
        ],
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Dem Mieter bleibt der Nachweis vorbehalten, dass durch die Barzahlung keine oder geringere Mehraufwände entstanden sind.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Bei Zahlungsverzug gelten für Verbraucher Verzugszinsen von 5 Prozentpunkten über dem Basiszinssatz. Der Mieter trägt zudem die durch den Verzug entstehenden adäquat-kausalen Kosten (Mahngebühren, Inkassokosten, Rechtsanwaltsgebühren). Dem Mieter bleibt der Nachweis vorbehalten, dass kein oder ein geringerer Schaden entstanden ist.",
          },
        ],
      },
    ],
    ...
    subsections: [
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Die Codes werden per SMS an die im Buchungsprozess angegebene Mobilfunknummer des Mieters versandt. Mit Eingabe seiner Mobilfunknummer im Buchungsprozess stimmt der Mieter dem Erhalt von SMS zum Zwecke der Abwicklung des Mietverhältnisses ausdrücklich zu.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Bei Übergabe hat der Mieter die Mietsache auf äußerlich erkennbare Mängel, Vollständigkeit und Funktion zu prüfen. Die Übernahme durch Unterzeichnung des Lieferscheins oder Übergabeprotokolls gilt als Anerkennung des äußerlich erkennbaren Zustandes. Die Haftung von SLT für verdeckte oder nicht ohne Weiteres erkennbare Mängel sowie die Garantiehaftung für anfängliche Mängel gemäß § 536a Abs. 1 BGB bleibt hiervon unberührt.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Schäden, Funktionsstörungen oder Verluste sind SLT unverzüglich, spätestens innerhalb von drei Werktagen nach Feststellung, in Textform anzuzeigen. Bei akuter Gefahr für Personen oder Sachen ist eine sofortige Meldung erforderlich. Bei schuldhaft unterlassener oder schuldhaft verspäteter Anzeige haftet der Mieter für die hieraus adäquat-kausal entstehenden Folgeschäden.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Wird die Mietsache verspätet, unvollständig oder verschmutzt zurückgegeben, ist SLT berechtigt, den Mehraufwand (insbesondere Reinigung, Desinfektion und zusätzliche Mietgebühren) in Rechnung zu stellen. Dem Mieter bleibt der Nachweis eines geringeren Aufwands vorbehalten.",
          },
          {
            type: "p",
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Eine Weiterfahrt mit erkannten oder erkennbaren sicherheitsrelevanten Mängeln stellt eine grobe Verletzung der Sorgfaltspflichten des Mieters dar.",
          },
          {
            type: "p",
          ...
          {
            type: "p",
            text: "(4) Die in dieser Sicherheitsklausel begründeten Pflichten des Mieters lassen die Verkehrssicherungspflicht und die Garantiehaftung von SLT als Vermieter gemäß §§ 535, 536, 536a BGB sowie die Halterhaftung gemäß § 7 StVG unberührt. SLT verpflichtet sich zur regelmäßigen Wartung, Hauptuntersuchung und Bremsenprüfung aller vermieteten Anhänger und Kraftfahrzeuge nach den jeweils geltenden gesetzlichen und berufsgenossenschaftlichen Vorschriften (insbesondere StVZO, DGUV Vorschrift 70).",
          },
          {
            type: "p",
    ...
    subsections: [
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Bei verspäteter Rückgabe schuldet der Mieter den anteiligen Mietzins für die Zeit der Überschreitung; jeder angefangene Tag gilt als voller Miettag. Zusätzlich kann SLT einen pauschalierten Verzugsschaden in Höhe von 20 % des Tagesbruttomietpreises pro verspätetem Tag verlangen. Dem Mieter bleibt der Nachweis vorbehalten, dass kein oder ein geringerer Schaden entstanden ist. SLT bleibt der Nachweis eines höheren konkreten Schadens vorbehalten.",
          },
        ],
      },
      {
    ...
    subsections: [
      {
        ...
        body: [
          ...
          {
            type: "p",
            text: "Die verschuldensunabhängige Garantiehaftung für anfängliche Mängel der Mietsache gemäß § 536a Abs. 1 BGB bleibt von dieser Haftungsbeschränkung unberührt.",
          },
          {
            type: "p",
    ...
    subsections: [
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            type: "list",
            items: [
              "a) bis 14 Tage vor Mietbeginn: 25 %",
              "b) bis 7 Tage vor Mietbeginn: 40 %",
              "c) bis 3 Tage vor Mietbeginn: 60 %",
              "d) bis 48 Stunden vor Mietbeginn: 75 %",
              "e) bei späterer Stornierung oder Nichtabholung: 85 %",
            ],
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Dem Mieter bleibt ausdrücklich der Nachweis vorbehalten, dass SLT kein oder nur ein wesentlich geringerer Schaden entstanden ist (z.B. durch anderweitige Vermietung, ersparte Auf- und Abbau-, Transport- oder Personalkosten). SLT bleibt umgekehrt der Nachweis eines höheren, konkret entstandenen Schadens vorbehalten.",
          },
        ],
      },
      {
      ...
      },
      {
        id: "vi-6-5",
        number: "6.5",
        title: "Gesetzliche Rechte",
        body: [
          {
            type: "p",
            text: "Gesetzliche Rücktritts-, Kündigungs- und Gewährleistungsrechte des Mieters bleiben unberührt.",
          },
        ],
      },
    ],
    ...
    subsections: [
      {
        ...
        body: [
          {
            type: "p",
            text: "Der Mieter verpflichtet sich, alle geltenden gesetzlichen und behördlichen Vorschriften (insbesondere Unfallverhütungsvorschriften, Straßenverkehrsordnung, Führerscheinpflicht, Betriebssicherheitsverordnung) einzuhalten und alle erforderlichen Erlaubnisse und Genehmigungen einzuholen.",
          },
          {
            type: "p",
            text: "Für Verstöße gegen gesetzliche Vorschriften haftet der Mieter im Rahmen der gesetzlichen Bestimmungen und stellt SLT von berechtigten Ansprüchen Dritter frei.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "(a) Funktion und Zweck: Bestimmte Mietgeräte (insbesondere höherwertige Baumaschinen, Arbeitsbühnen, Stromaggregate, Anhänger und Kraftfahrzeuge) sind mit einem GPS-Ortungssystem ausgestattet. Die Verarbeitung der Standort- und Betriebsdaten dient ausschließlich der Diebstahlprävention, der Wiederbeschaffung im Verlust- oder Diebstahlsfall sowie der technischen Fernüberwachung sicherheitsrelevanter Betriebszustände (z.B. Akkustand, Motorbetriebsstunden).",
          },
          {
            type: "p",
            text: "(b) Rechtsgrundlage: Die Verarbeitung erfolgt auf Grundlage des berechtigten Interesses gemäß Art. 6 Abs. 1 lit. f DSGVO. Das berechtigte Interesse von SLT besteht im Schutz des Eigentums vor Diebstahl, Unterschlagung und unbefugter Verbringung. Eine permanente Echtzeit-Ortung erfolgt nicht; eine konkrete Standortabfrage wird nur bei Verdacht auf Diebstahl, unbefugte Ausfuhr aus Deutschland oder Verlust der Mietsache durchgeführt.",
          },
          {
            type: "p",
            text: "(c) Datenkategorien: Geographische Position (Längen-/Breitengrad), Zeitstempel, technische Betriebsdaten (z.B. Zünd-Status, Akku-/Tankfüllstand, Betriebsstunden).",
          },
          {
            type: "p",
          ...
          {
            type: "p",
            text: "(f) Betroffenenrechte: Dem Mieter stehen die Rechte aus Art. 15–22 DSGVO zu (Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit, Widerspruch). Ein Widerspruch gegen die Ortung im Sinne von Art. 21 DSGVO führt aus Sicherheitsgründen regelmäßig dazu, dass die betreffende Mietsache nicht vermietet werden kann. Beschwerden können bei der zuständigen Aufsichtsbehörde (Landesbeauftragte für Datenschutz und Informationsfreiheit Nordrhein-Westfalen) eingelegt werden.",
          },
          {
            type: "p",
    ...
    subsections: [
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Für Verzögerungen oder Mehraufwand, die nicht durch SLT zu vertreten sind (z.B. fehlende Zugänglichkeit, Wartezeiten, notwendiges zusätzliches Personal, erforderliche Rückfragen), trägt der Mieter die adäquat-kausal entstehenden Kosten.",
          },
          {
            type: "p",
    ...
    subsections: [
      {
        ...
        body: [
          {
            type: "p",
            text: "Es gilt ergänzend die Datenschutzerklärung von SLT, abrufbar unter www.slt-rental.de/datenschutz.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Für alle Streitigkeiten aus oder im Zusammenhang mit dem Mietverhältnis gilt das Recht der Bundesrepublik Deutschland. Die zwingenden verbraucherschützenden Vorschriften des Staates, in dem der Verbraucher seinen gewöhnlichen Aufenthalt hat, bleiben unberührt.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Für Streitigkeiten zwischen SLT und dem Mieter gelten die gesetzlichen Gerichtsstände gemäß §§ 12 ff. ZPO.",
          },
        ],
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Die SLT Technology Group GmbH & Co. KG ist weder verpflichtet noch bereit, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle im Sinne des Verbraucherstreitbeilegungsgesetzes (VSBG) teilzunehmen.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          {
            type: "p",
            text: "Sollten einzelne Bestimmungen dieser AGB ganz oder teilweise unwirksam sein oder werden, berührt dies nicht die Gültigkeit der übrigen Bestimmungen. An die Stelle der unwirksamen Bestimmung tritt die gesetzliche Regelung.",
          },
        ],
      },
    ],
