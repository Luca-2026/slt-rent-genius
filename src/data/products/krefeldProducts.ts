...
import imgRollgeruestKrause84m1 from "@/assets/products/rollgeruest-krause-84m-1.jpeg";
import imgRollgeruestKrause84m2 from "@/assets/products/rollgeruest-krause-84m-2.jpeg";
import imgRollgeruestKrause84m3 from "@/assets/products/rollgeruest-krause-84m-3.jpeg";
...
import rollgeruest7_4m_1 from "@/assets/products/rollgeruest-breitaufbau-7-4m-1.jpeg";
import rollgeruest7_4m_2 from "@/assets/products/rollgeruest-breitaufbau-7-4m-2.jpeg";
import rollgeruest6_4m_1 from "@/assets/products/rollgeruest-breitaufbau-6-4m-1.jpeg";
...
const imgEndverteilerEv32_1 = "/product-images/endverteiler-ev32-1.jpg";
const imgEndverteilerEv32_2 = "/product-images/endverteiler-ev32-2.jpg";
const imgEndverteilerEv32_3 = "/product-images/endverteiler-ev32-3.jpg";
const imgEndverteilerEv63_1 = "/product-images/endverteiler-ev63-1.png";
const imgEndverteilerEv63_2 = "/product-images/endverteiler-ev63-2.jpg";
const imgEndverteilerEv63_3 = "/product-images/endverteiler-ev63-3.webp";
const imgHauptverteilerHv125_1 = "/product-images/hauptverteiler-hv125-1.png";
...
import imgLedOutdoorscheinwerfer6er1 from "@/assets/products/led-outdoorscheinwerfer-6er-set-1.jpg";
...
export const verdichtungProducts: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      "Marke": "Baumax",
      "Typ": "VP 15/50W",
      "Maschinenart": "Rüttelplatte vorwärtslaufend",
      "Betriebsgewicht": "97 kg",
      "Grundplattengröße (B × L)": "500 × 500 mm",
      "Zentrifugalkraft": "14 kN",
      "Frequenz": "105 Hz",
      "Arbeitsgeschwindigkeit max.": "20 m/min",
      "Flächenleistung max.": "600 m²/h",
      "Steigfähigkeit max.": "25 %",
      "Erregersystem": "vorwärtslaufend",
      "Wassertank / Sprinkleranlage": "Ja – zur Staubbindung",
      "Motor": "1-Zylinder, 4-Takt OHV, luftgekühlt",
      "Motorhersteller": "Loncin",
      "Hubraum": "196 cm³",
      "Motorleistung max.": "4,8 kW",
      "Kraftstoff": "Benzin",
      "Kraftstoffinhalt": "3,5 l",
      "Kraftstoffverbrauch": "0,9 l/h",
      "Startsystem": "Reversierstarter",
      "Kraftübertragung": "Fliehkraftkupplung / Keilriemen",
      "Arbeitshöhe (Unterfahrhöhe)": "540 mm",
      "Höhe Führungsgriff (Arbeitsposition)": "920 mm",
      "Maschinenlänge (Arbeitsposition)": "1.100 mm",
      "Maschinenlänge (Transportposition)": "720 mm",
    },
  },
  {
...
export const werkzeugeProducts: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      "Modell": "GSH 16-28",
      "Schlagenergie": "41 J",
      "Schlagzahl bei Nenndrehzahl": "1.280 bpm",
      "Nenneingangsleistung": "1.750 W",
      "Spannung": "230 V",
      "Gewicht": "18,3 kg",
      "Werkzeugaufnahme": "HEX-28",
      "Schwingungsemissionswert (Meißeln in Beton)": "12,3 m/s² (K = 1,5 m/s²)",
  ...
  },
  {
    ...
    name: "Abbruchhammer 72,8J / 31kg",
    modelName: "Makita HM1812",
    description: "Schwerer Makita HM1812 Abbruchhammer mit 72,8 J Schlagenergie, 2.000 W und 31 kg Eigengewicht – ideal für Boden- und Fundamentabbruch sowie schwere Stemmarbeiten in Beton.",
    detailedDescription: "Der Makita HM1812 ist ein leistungsstarker Abbruchhammer der 30-kg-Klasse mit 2.000 W und 72,8 J Schlagenergie. Dank AVT (Anti-Vibrations-Technologie) wird die Hand-Arm-Belastung des Anwenders deutlich reduziert, sodass auch längere Stemmarbeiten in Beton, Asphalt oder Estrich möglich sind. Die HEX-28-Werkzeugaufnahme erlaubt schnellen Werkzeugwechsel ohne Zusatzwerkzeug. Mit 31 kg Gewicht entwickelt das Gerät die nötige Massenwirkung für Boden- und Fundamentabbrüche.\n\nLieferumfang: 1× Spitzmeißel und 1× Flachmeißel.",
    ...
    specifications: {
      ...
      "Werkzeugaufnahme": "HEX-28",
      "Vibrationsdämpfung": "AVT (Anti-Vibrations-Technologie)",
      "Lieferumfang": "1× Spitzmeißel, 1× Flachmeißel",
    },
...
export const absperrtechnikProducts: Product[] = [
  ...
  },
  {
    ...
    sortOrder: 0,
    rentwareCode: { krefeld: "ONFC2E", muelheim: "BX4E9Q" }
  },
  {
    id: "vz-308-ra1",
    name: "VZ 308, RA1",
...
export const beschallungProducts: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      "Subwoofer": "2× DAS Audio VANTEC-18A (aktiv, 18\")",
      "Tops": "2× DAS Audio VANTEC-12A (aktiv, 12\")",
      "Bluetooth": "Ja (in den Topteilen integriert)",
      "App-Steuerung": "DAS Audio Aliante App (iOS/Android)",
      "Presets": "u.a. Live-Musik, DJ/Playback, Sprache",
  ...
  },
  {
    ...
    images: [
      ...
      "/product-images/cdj-3000x-3.jpeg",
      "/product-images/cdj-3000x-4.jpeg",
    ],
    image: "/product-images/cdj-3000x-1.jpeg",
    imageAlts: [
      "AlphaTheta CDJ-3000X mieten – DJ-Multiplayer von oben mit 10,1-Zoll-Touchscreen, Jogwheel und Hot Cues",
      "CDJ-3000X mieten – Profi-DJ-Player in Frontansicht mit Wellenformanzeige und Tempo-Fader",
      "CDJ-3000X DJ-Player im Detail – Jogwheel mit Grafikdisplay und beleuchteten CUE- und Play-Tasten",
      "Rückseite des CDJ-3000X – Cinch-Audio-Out, Digital-Out, LAN für PRO DJ LINK, USB-C und Netzanschluss",
    ],
    detailedDescription:
      "Der CDJ-3000X von AlphaTheta (Pioneer DJ) ist der aktuelle Club-Standard unter den DJ-Multiplayern und bei uns an allen Standorten auf Anfrage mietbar. Herzstück ist das 10,1 Zoll große, kapazitive Vollfarb-Touchscreen-Display, auf dem Wellenform, Hot Cues, Beat-Grid und Bibliothek gleichzeitig im Blick bleiben. Über den Jogwheel-Widerstand (Jog Feel) lässt sich das Spielgefühl von leichtgängig bis schwergängig einstellen.\n\nAngespielt wird von USB-Flash-Speichern, USB-SSDs und -Festplatten, von PC/Mac über USB oder LAN sowie von iOS- und Android-Geräten. Unterstützt werden MP3, AAC, WAV, AIFF, FLAC und ALAC; als Dateisysteme FAT16, FAT32, exFAT und HFS+ (NTFS wird nicht unterstützt). Über PRO DJ LINK (LAN) und integriertes WLAN (IEEE 802.11a/b/g/n/ac) lassen sich mehrere Player vernetzen; CloudDirectPlay spielt Tracks über Dropbox oder Google Drive direkt ab, auch Apple Music, Beatport Streaming und TIDAL werden unterstützt. Kompatible Software: rekordbox für Mac/Windows und iOS/Android, Serato DJ Pro (Lizenz erforderlich) und djay Pro für Mac/Windows (Abo erforderlich).\n\nKlanglich arbeitet der Player mit einem 96 kHz/32-Bit-DAC und eigener Stromversorgung: Frequenzgang 4 Hz – 40 kHz, Rauschabstand 115 dB, Klirrfaktor 0,0018 %. Ausgangsseitig stehen ein analoger Cinch-Ausgang und ein koaxialer Digitalausgang bereit; für Speicher und Rechner gibt es 1× USB Typ A und 2× USB Typ C, dazu eine LAN-Buchse und NFC-Anmeldung.\n\nMit 344,6 × 490,4 × 130,1 mm (B × T × H) und 6,0 kg passt der Player in jedes DJ-Case und lässt sich problemlos im Pkw transportieren. Zum Lieferumfang gehören Netzkabel, Audiokabel (analog/digital), LAN-Kabel, Schnellstartanleitung und Sicherheitshinweise. Der Betrieb erfolgt an 100–240 V Wechselstrom, 50/60 Hz. Da wir den CDJ-3000X an allen drei Standorten – Krefeld, Bonn und Mülheim an der Ruhr – auf Anfrage vermieten, stimmen wir Verfügbarkeit, Stückzahl (typisch als 2er-Setup mit Mixer) und Termine direkt mit dir ab.",
    specifications: {
      "Typ": "DJ-Multiplayer (Media Player)",
      "Display": "10,1 Zoll, kapazitives Vollfarben-Touchscreen-Display",
      "Wiedergabefähige Medien": "USB-Flash-Speicher, USB-SSD/-HDD, PC/Mac (USB/LAN), Mobilgeräte (iOS/Android)",
      "Unterstützte Audio-Formate": "MP3, AAC, WAV, AIFF, FLAC, ALAC",
      "Unterstützte USB-Formate": "FAT16, FAT32, exFAT, HFS+ (NTFS wird nicht unterstützt)",
      "Konnektivität": "USB Typ A × 1, USB Typ C × 2, LAN × 1 (PRO DJ LINK), Wi-Fi (IEEE 802.11a/b/g/n/ac), NFC-Anmeldung",
      "Ausgänge": "Analog (Cinch) × 1, Digital (koaxial) × 1",
      "D/A-Wandler": "96 kHz / 32 Bit",
      "Frequenzgang": "4 Hz – 40 kHz",
      "Rauschabstand": "115 dB",
      "Klirrfaktor": "0,0018 %",
      "Kompatible Software": "rekordbox (Mac/Windows, iOS/Android), Serato DJ Pro (Lizenz erforderlich), djay Pro (Abo erforderlich)",
      "Streaming-Dienste": "Apple Music, Beatport Streaming, TIDAL",
      "Cloud": "CloudDirectPlay über Dropbox und Google Drive",
      "Abmessungen (B × T × H)": "344,6 × 490,4 × 130,1 mm",
      "Gewicht": "6,0 kg",
      "Stromversorgung": "100–240 V Wechselstrom, 50/60 Hz",
      "Lieferumfang": "Netzkabel, Audiokabel (analog/digital), LAN-Kabel, Schnellstartanleitung, Sicherheitshinweise",
      "Standorte": "Krefeld, Bonn und Mülheim an der Ruhr – jeweils auf Anfrage",
    },
    features: [
      "10,1\"-Touchscreen mit Wellenform, Beat-Grid und Bibliothek auf einen Blick",
      "PRO DJ LINK über LAN plus integriertes WLAN für Multi-Player-Setups",
      "CloudDirectPlay mit Dropbox und Google Drive – ohne USB-Stick spielbar",
      "Streaming von Apple Music, Beatport Streaming und TIDAL",
      "96 kHz/32-Bit-DAC, Frequenzgang 4 Hz – 40 kHz, 115 dB Rauschabstand",
      "USB Typ C × 2 und USB Typ A × 1 für Speicher und Laptop-Anbindung",
      "Einstellbarer Jogwheel-Widerstand (Jog Feel) von leicht bis schwer",
      "Nur 6,0 kg – transportabel im Pkw, passend für gängige DJ-Cases",
    ],
    rentalNotes: [
      "Der CDJ-3000X ist an allen Standorten auf Anfrage verfügbar – Verfügbarkeit und Stückzahl stimmen wir vor der Buchung mit dir ab.",
      "Üblich ist die Miete als 2er-Setup mit passendem DJ-Mixer; Mixer bitte separat mit anfragen.",
      "Netzkabel, Audiokabel (analog/digital) und LAN-Kabel sind im Lieferumfang enthalten.",
      "USB-Sticks bzw. Datenträger mit deiner Musik bringst du selbst mit; NTFS-formatierte Medien werden nicht unterstützt.",
      "Rückgabe bitte im mitgelieferten Transportzustand, sauber und vollständig mit allen Kabeln.",
    ],
    externalManualUrl: "https://www.pioneerdj.com/support/manuals/player/cdj-3000x/de/index.html",
    tags: ["event", "dj", "party", "hochzeit", "club", "profi"],
  },
  {
    id: "djm-a9",
    name: "AlphaTheta DJM-A9 DJ-Mixer",
    modelName: "DJM-A9 – 4-Kanal-Profi-DJ-Mixer mit MAGVEL FADER PRO, Bluetooth-Eingang und WLAN",
    description: "DJM-A9 mieten: 4-Kanal-Profi-DJ-Mixer von AlphaTheta (Pioneer DJ) mit MAGVEL FADER PRO, X-PAD, Bluetooth-Eingang, WLAN und 96 kHz/32-Bit-Wandlern. Ab 59 € je Wochenende – an allen Standorten auf Anfrage.",
    category: "beschallung",
    onRequest: true,
    pricePerDay: "ab 59 €",
    priceUnitLabel: "/ Wochenende",
    images: [
      "/product-images/djm-a9-1.jpeg",
      "/product-images/djm-a9-2.jpeg",
      "/product-images/djm-a9-3.jpeg",
      "/product-images/djm-a9-4.jpeg",
    ],
    image: "/product-images/djm-a9-1.jpeg",
    imageAlts: [
    ...
    specifications: {
      "Typ": "4-Kanal-Profi-DJ-Mixer",
      "Abtastrate": "96 kHz",
      "D/A-Wandler (MASTER, BOOTH, REC, SEND)": "32 Bit",
      "A/D-Wandler (Kanaleingang)": "32 Bit",
      "Weitere A/D- und D/A-Wandler": "24 Bit",
      "Frequenzgang (LINE)": "20 Hz – 40 kHz",
      "Klirrfaktor (LINE – MASTER 1)": "0,005 %",
      "Rauschabstand": "USB/Digital In 114 dB, LINE 105 dB, PHONO 88 dB, MIC 79 dB",
      "Übersprechen (LINE)": "82 dB",
      "Kanal-Equalizer": "HI/MID/LOW jeweils -26 dB bis +6 dB (20 kHz / 1 kHz / 20 Hz)",
      "Booth-Monitor-EQ": "HI -12 dB bis +6 dB (10 kHz), LOW -12 dB bis +6 dB (100 Hz)",
      "Eingänge": "4× PHONO (Cinch), 4× LINE (Cinch), 4× DIGITAL IN (koaxial), MIC 1 (XLR/6,3 mm TRS, 48 V Phantom), MIC 2 (6,3 mm TRS), RETURN (6,3 mm TS)",
      "Ausgänge": "MASTER (XLR + Cinch), BOOTH (6,3 mm TRS), REC OUT (Cinch), SEND (6,3 mm TS), DIGITAL MASTER OUT (koaxial)",
      "Kopfhörerausgänge": "2× 6,3 mm Stereo und 2× 3,5 mm Stereo-Mini (PHONES A und B)",
      "USB": "USB Typ A × 1 (5 V / 2,1 A), USB Typ B / Typ C × 2",
      "Netzwerk": "LAN 100BASE-TX (PRO DJ LINK)",
      "WLAN": "IEEE 802.11 a/b/g/n/ac, 2,4 GHz / 5 GHz",
      "Bluetooth": "Bluetooth Ver. 5.0, ca. 10 m Reichweite, 2,4 GHz",
      "Abmessungen (B × T × H)": "407,4 × 458,3 × 107,9 mm (mit aufgestellter Antenne 140,7 mm hoch)",
      "Gewicht": "10,2 kg",
      "Stromversorgung": "AC 110 V – 240 V, 50/60 Hz",
      "Leistungsaufnahme": "61 W (Standby 0,3 W)",
    ...
    pdfUrl: "/manuals/djm-a9-bedienungsanleitung.pdf",
    externalManualUrl: "https://www.pioneerdj.com/de/product/dj-mixers/djm-a9/",
    tags: ["event", "dj", "party", "hochzeit", "club", "profi"],
  },
  {
...
export const spezialeffekteProducts: Product[] = [
  ...
  },
  {
    ...
    name: "Kalt-Funkenfontäne (Spark / Sparkular), 2er Set",
    description: "2er Set Kalt-Funkenfontänen (Spark / Sparkular) im Flightcase – zwei Geräte für symmetrische Funkeneffekte bis 6 m Höhe. Vollkommen ungefährlich, kein Geruch, kein Rauch – ideal für Bühnen, Hochzeiten und Events.",
    detailedDescription: "Mit diesen Spark- bzw. Sparkular-Geräten erzeugen Sie auf Knopfdruck fantastische Kalt-Funkenfontänen für jegliche Veranstaltungen. Die bis zu 6 Meter hohen Fontänen sind dabei vollkommen ungefährlich und erzeugen weder Geruch noch Rauch.\n\n✅ bis zu 6 Meter hohe Funkenfontänen\n✅ kinderleichte Bedienung über Fernbedienung oder DMX\n✅ Höhe stufenlos einstellbar\n✅ inkl. einer Granulat-Füllung pro Gerät (bis zu 10 min. Effektzeit)\n\nJede weitere Minute Effektzeit wird mit 3,00 € berechnet.\n\nWichtiger Hinweis: Nach jeder Benutzung unbedingt „Clear Powder“ auf der Fernbedienung drücken – sonst verklumpt das Granulat im Gerät!",
  ...
  },
  {
    ...
    name: "Kalt-Funkenfontäne (Spark / Sparkular), 4er Set",
    description: "4er Set Kalt-Funkenfontänen (Spark / Sparkular) im Flightcase – vier Geräte für spektakuläre Funkeneffekte bis 6 m Höhe auf großen Bühnen und Events. Vollkommen ungefährlich, kein Geruch, kein Rauch.",
    detailedDescription: "Mit diesen Spark- bzw. Sparkular-Geräten erzeugen Sie auf Knopfdruck fantastische Kalt-Funkenfontänen für jegliche Veranstaltungen. Die bis zu 6 Meter hohen Fontänen sind dabei vollkommen ungefährlich und erzeugen weder Geruch noch Rauch.\n\n✅ bis zu 6 Meter hohe Funkenfontänen\n✅ kinderleichte Bedienung über Fernbedienung oder DMX\n✅ Höhe stufenlos einstellbar\n✅ inkl. einer Granulat-Füllung pro Gerät (bis zu 10 min. Effektzeit)\n\nJede weitere Minute Effektzeit wird mit 3,00 € berechnet.\n\nWichtiger Hinweis: Nach jeder Benutzung unbedingt „Clear Powder“ auf der Fernbedienung drücken – sonst verklumpt das Granulat im Gerät!",
...
export const moebelZelteProducts: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      "Durchgangshöhe": "2,3 m (extra hoch)",
      "Farbe": "weiß",
      "Material": "UV-beständige 500 g/m² PVC-Plane, rasterfaserverstärkt",
      "Brandschutz": "feuerfest nach EN-13501-1",
      "Inklusive": "Dachspanner gegen Wassersäcke",
      "Kapazität (Stehend)": "ca. 100 Personen (0,6 m²/Person)",
      "Kapazität (Bestuhlung)": "ca. 84 Personen (0,71 m²/Person)",
      "Hinweis": "Trocken zurückgeben (Trocknungspauschale 150 € bei Nichtbeachtung)",
    },
    rentwareCode: { krefeld: "GKQJTC" }
  },
  {
    id: "eventzelt-6x12m",
...
export const leiternGeruesteProducts: Product[] = [
  ...
  // --- Kombileiter ---
  {
    ...
    image: mehrzweckleiter3x12_1,
    images: [mehrzweckleiter3x12_1],
  ...
  // --- Rollgerüst ---
  {
    ...
    name: "Rollgerüst – 3,3 m Arbeitshöhe (2,00 × 1,20 m)",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 4,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 5,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 6,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 9,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    rentwareCode: { krefeld: "55QTF9" },
    pdfUrl: "/manuals/krause-rollgeruest-stabilo-serie-10-50-aufbauanleitung.pdf",
    onRequest: true,
  },
  {
    id: "rollgeruest-krause-6-4m",
    ...
    images: [imgRollgeruestKrause64m1, imgRollgeruestKrause64m2, imgRollgeruestKrause64m3],
    category: "rollgeruest",
    specifications: {
      "Arbeitshöhe": "6,4 m",
      "Gerüsthöhe": "5,5 m",
    ...
    rentwareCode: { krefeld: "HGHBJW" },
    pdfUrl: "/manuals/krause-rollgeruest-stabilo-serie-10-50-aufbauanleitung.pdf",
    onRequest: true,
  },
  {
    id: "rollgeruest-krause-7-4m",
    ...
    images: [imgRollgeruestKrause74m1, imgRollgeruestKrause74m2, imgRollgeruestKrause74m3],
    category: "rollgeruest",
    specifications: {
      "Arbeitshöhe": "6,4 m",
      "Gerüsthöhe": "5,5 m",
    ...
    rentwareCode: { krefeld: "NFJLTZ" },
    pdfUrl: "/manuals/krause-rollgeruest-stabilo-serie-10-50-aufbauanleitung.pdf",
    onRequest: true,
  },
  {
    id: "rollgeruest-krause-8-4m",
    ...
    images: [imgRollgeruestKrause84m1, imgRollgeruestKrause84m2, imgRollgeruestKrause84m3],
    category: "rollgeruest",
    specifications: {
      "Arbeitshöhe": "8,4 m",
      "Gerüsthöhe": "7,5 m",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 8,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 7,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 10,4 m Arbeitshöhe",
  ...
  },
  {
    ...
    name: "Rollgerüst Breitaufbau – 11,4 m Arbeitshöhe",
  ...
  {
    id: "krause-rollgeruest-breitaufbau-12-4m",
    name: "Rollgerüst Breitaufbau – 12,4 m Arbeitshöhe",
    description: "KRAUSE Rollgerüst Breitaufbau mit einer Arbeitsfläche von 2,00 × 1,50 m und 12,4 m Arbeitshöhe (Gerüsthöhe 11,5 m, Standhöhe 10,4 m). TÜV-geprüft nach DIN EN 1004-1, Belastbarkeit 200 kg/m² (Gerüstgruppe 3). Höhenverstellbare Fahrrollen Ø 150 mm (220–335 mm) gleichen unebenes Gelände aus. Das selbstsichernde KRAUSE-Verriegelungssystem ermöglicht einen sicheren Auf- und Abbau; die Standfläche von über 3,00 m² bietet viel Platz für Personal und Material.",
    detailedDescription: "KRAUSE Rollgerüst Breitaufbau mit einer Arbeitsfläche von 2,00 × 1,50 m. Hier sorgt das komfortabel aufzubauende Verriegelungssystem für eine besonders hohe Stabilität.\n\nArbeitshöhe: 12,4 m\nGerüsthöhe: 11,5 m\nStandhöhe: 10,4 m\nHöhenverstellbare Fahrrollen Ø 150 mm (stufenloser Verstellbereich: 220–335 mm)\n\nTÜV-geprüft, Belastbarkeit 200 kg/m² (Gerüstgruppe 3) nach DIN EN 1004-1.\n\nDurch die Befestigung des Geländerrahmens vor dem Einhängen der nächsthöheren Belagbühne ist der sichere Aufbau gewährleistet. Beim Durchsteigen der Belagbühne ist ein komplettes Geländer und damit eine Absturzsicherung vorhanden.\n\nDas selbstsichernde KRAUSE-Verriegelungssystem mit einer formschlüssigen Verbindung ermöglicht den einfachen, schnellen und sicheren Auf- und Abbau.\n\nDie Standfläche von über 3,00 m² bietet einen großen und sicheren Arbeitsplatz für Personal und Material.",
    image: rollgeruest11_4m_1,
    images: [rollgeruest11_4m_1, rollgeruest11_4m_2],
    category: "rollgeruest",
    pdfUrl: "/manuals/krause-rollgeruest-stabilo-serie-10-50-aufbauanleitung.pdf",
...
export const erdbewegungZusatzProducts: Product[] = [
  ...
  // Mobile Tankstelle
  {
    ...
    category: "zubehoer",
    compatibleMachines: ["minibagger-2-7t", "bobcat-e35z", "bobcat-e50z", "kramer-5045"],
...
// ============= GASTRO EQUIPMENT =============
export const gastroEquipmentProducts: Product[] = [
  {
  ...
  {
    id: "slt-eiswuerfelmaschine-profi-45kg",
    name: "SLT Eiswürfelmaschine Profi – 45 kg/24 h Edelstahl",
    modelName: "Profi-Modell 45 kg/Tag – für Gastronomie, Bar & Großevents",
    description: "Gastro-Eiswürfelmaschine mit 45 kg Eis pro 24 h – 45 Würfel je Zyklus in 8 bis 18 Minuten, 28,4 l Vorratsbehälter, Edelstahl, LED-Display, Selbstreinigung.",
    image: sltEiswuerfelmaschineProfi1,
    images: [sltEiswuerfelmaschineProfi1, sltEiswuerfelmaschineProfi2],
    imageAlts: [
      "Profi-Eiswürfelmaschine mieten – Edelstahlgerät mit Sichtfenster und LED-Bedienfeld",
      "Eiswürfelmaschine 45 kg mieten – Abmessungen 80 x 40 x 50 cm sowie Eisschaufel, Zulauf- und Ablaufschlauch",
    ],
    category: "eiswuerfel",
    onRequest: true,
    detailedDescription:
      "Die große Profi-Variante unserer Eiswürfelmaschinen zum Mieten ist auf den Dauerbetrieb in Gastronomie, Catering, Bar- und Eventbetrieb ausgelegt. Sie produziert bis zu 45 kg Eiswürfel in 24 Stunden; pro Zyklus entstehen 45 Würfel in 8 bis 18 Minuten. Damit versorgt ein einziges Gerät mehrere Cocktail-Stationen und Ausschankpunkte gleichzeitig.\n\nDer Vorratsbehälter fasst 28,4 Liter und damit rund 15 kg Eiswürfel; ein Sichtfenster zeigt den Füllstand auf einen Blick. Die Würfelgröße lässt sich am LED-Display mit Multi-Touch-Bedienfeld wählen, ein einstellbarer Timer startet die Produktion vorab. Eine automatische Selbstreinigungsfunktion hält die Anlage hygienisch, ohne den Betrieb zu unterbrechen. Alle Materialien im Eiskontakt sind geschmacks- und geruchsneutral, das Gehäuse besteht aus Edelstahl.\n\nDer industrielle Pumpenkreislauf arbeitet mit festem Wasseranschluss; Zu- und Ablaufschlauch sind im Lieferumfang enthalten. Die Kompressorleistung beträgt 370 W bei 220–240 V und 50/60 Hz, als Kältemittel kommt R290 zum Einsatz. Höhenverstellbare Standfüße gleichen unebene Untergründe aus, das Netzkabel ist 1,8 m lang.\n\nDas Gerät misst 80 x 40 x 50 cm (H x B x T) bei 25,5 kg Eigengewicht und passt damit unter viele Tresen und auf jede stabile Arbeitsfläche. Verfügbar über die Standorte Krefeld, Bonn und Mülheim an der Ruhr. In Mülheim an der Ruhr erfolgt die Bereitstellung auf Anfrage per Lieferung aus Krefeld – wir prüfen die Verfügbarkeit für deinen Zeitraum und melden uns kurzfristig mit einem Angebot inklusive Lieferkosten zurück.",
    specifications: {
      "Geräteart": "Gastro-Eiswürfelbereiter, freistehend / Untertheken-Aufstellung",
      "Material": "Edelstahlgehäuse",
      "Tageskapazität": "45 kg Eiswürfel in 24 Stunden",
      "Zyklusleistung": "45 Eiswürfel je Zyklus",
      "Zyklusdauer": "8 bis 18 Minuten",
      "Vorratsbehälter": "28,4 Liter (ca. 15 kg Eiswürfel)",
      "Würfelgröße": "Wählbar über LED-Bedienfeld",
      "Bedienung": "LED-Display mit Multi-Touch-Bedienfeld und einstellbarem Timer",
      "Reinigung": "Automatische Selbstreinigungsfunktion",
      "Wasserversorgung": "Industrieller Pumpenkreislauf mit festem Wasseranschluss, Zu- und Ablaufschlauch im Lieferumfang",
      "Leistung": "370 W",
      "Spannung": "220–240 V, 50/60 Hz",
      "Kältemittel": "R290",
      "Abmessungen": "80 x 40 x 50 cm (H x B x T)",
      "Gewicht": "25,5 kg",
      "Netzkabellänge": "1,8 m",
      "Standfüße": "Höhenverstellbar",
      "Einsatzbereich": "Bars, Restaurants, Cafés, Hotels, Cateringbetriebe, Events",
    },
    features: [
      "45 kg Eiswürfel pro 24 Stunden",
      "45 Würfel je Zyklus in 8 bis 18 Minuten",
      "28,4 l Vorratsbehälter (ca. 15 kg Eis) mit Sichtfenster",
      "Wählbare Eiswürfelgröße über LED-Display",
      "Automatische Selbstreinigungsfunktion",
      "Einstellbarer Timer für die Eisproduktion",
      "Fester Wasseranschluss mit Zu- und Ablaufschlauch im Lieferumfang",
      "Edelstahlgehäuse, geschmacks- und geruchsneutrale Materialien im Eiskontakt",
      "Kältemittel R290, 370 W Leistung",
      "Höhenverstellbare Standfüße",
    ],
    rentalNotes: [
      "Für den Dauerbetrieb wird ein Wasseranschluss sowie ein Ablauf benötigt; Zu- und Ablaufschlauch sind im Lieferumfang enthalten.",
      "Abmessungen 80 x 40 x 50 cm (H x B x T), Gewicht 25,5 kg – Transport stehend, zu zweit heben.",
      "Rückgabe entleert und grob gereinigt.",
      "In Mülheim an der Ruhr auf Anfrage verfügbar: Die Maschine wird aus Krefeld geliefert. Lieferkosten nennen wir dir im Angebot.",
    ],
    tags: ["event", "hochzeit", "gastronomie", "bar", "catering", "profi"],
  },
  {
    id: "schwenkgrill-profi-120",
    name: "Profi-Schwenkgrill Ø 120 cm",
    modelName: "Großer Schwenkgrill mit 120 cm Rost – für Vereinsfeste, Firmenfeiern & Catering",
    description: "Profi-Schwenkgrill mit 120 cm Grillrost, Kurbelzug und Feuerschale – für große Gruppen. Ab 90 € pro Tag, in Krefeld dauerhaft im Bestand.",
    category: "grill",
    onRequest: true,
    pricePerDay: "ab 90 €",
    images: [
      "/product-images/schwenkgrill-profi-120-1.jpeg",
      "/product-images/schwenkgrill-profi-120-2.jpeg",
    ],
    image: "/product-images/schwenkgrill-profi-120-1.jpeg",
    imageAlts: [
      "Profi-Schwenkgrill Ø 120 cm mieten – Edelstahl-Feuerschale mit rundem Grillrost am Kettenzug",
      "Schwenkgrill mieten – Gestell mit Handkurbel und Kette zur stufenlosen Höhenverstellung des 120-cm-Rostes",
    ],
    detailedDescription:
      "Der Profi-Schwenkgrill mit 120 cm Rostdurchmesser ist unser größter Holzkohlegrill zum Mieten – gebaut für Vereinsfeste, Schützenfeste, Firmenfeiern, Hochzeiten und Catering, wo viele Portionen gleichzeitig vom Rost müssen. Rund 1,1 m² Grillfläche bieten Platz für Bratwürste, Steaks, Spieße und Gemüse in einem Durchgang.\n\nDer runde Rost hängt an Ketten in einem stabilen Stahlgestell und wird über eine Handkurbel mit Seilzug stufenlos in der Höhe verstellt. So regelst du die Hitze über den Abstand zur Glut, statt Kohle nachschieben zu müssen – vom scharfen Angrillen bis zum Warmhalten. Der Rost lässt sich seitlich ausschwenken, um Glut nachzulegen oder das Grillgut bequem abzunehmen. Befeuert wird die Feuerschale mit Holzkohle, Briketts oder Holz.\n\nDas Gerät ist rund 2,20 m hoch und wird für den Transport liegend verladen – ein Kombi mit umgeklappter Rückbank reicht in der Regel nicht, ein Transporter oder Anhänger schon. Wer selbst kein passendes Fahrzeug hat, mietet bei uns optional direkt einen passenden Anhänger zum Ankoppeln mit dazu; alternativ liefern wir den Grill an. Am Hauptsitz Krefeld ist der Schwenkgrill dauerhaft im Bestand, für Bonn und Mülheim an der Ruhr disponieren wir ihn aus Krefeld.",
    specifications: {
      "Bauart": "Schwenkgrill mit Gestell, Kettenaufhängung und Handkurbel",
      "Rostdurchmesser": "120 cm",
      "Grillfläche": "ca. 1,1 m²",
      "Höhe": "ca. 2,20 m",
      "Höhenverstellung": "Stufenlos über Kurbel/Seilzug",
      "Befeuerung": "Holzkohle, Briketts oder Holz",
      "Material": "Stahl / Edelstahl",
      "Transport": "Liegend transportierbar – passender Anhänger optional mietbar",
      "Aufstellort": "Nur im Freien, auf festem, nicht brennbarem Untergrund",
      "Standort": "Krefeld dauerhaft im Bestand; Bonn und Mülheim an der Ruhr auf Anfrage",
    },
    features: [
      "120 cm Rostdurchmesser – ca. 1,1 m² Grillfläche für große Gruppen",
      "Stufenlose Höhenverstellung per Handkurbel statt Kohleschieben",
      "Rost ausschwenkbar zum Nachlegen und Abnehmen",
      "Befeuerung wahlweise mit Holzkohle, Briketts oder Holz",
      "Liegend transportierbar – optional mit passendem Anhänger",
      "Lieferung nach Lieferkosten-Tarif A (Sprinter Standard) möglich",
    ],
    rentalNotes: [
      "Holzkohle, Briketts, Anzünder und Grillbesteck sind nicht im Mietpreis enthalten.",
      "Richtwert Holzkohle: Für den 120-cm-Rost sind rund 6–8 kg Grundfüllung realistisch, plus Nachschub bei längerer Grilldauer. Briketts halten die Glut länger, stückige Holzkohle wird schneller heiß.",
      "Betrieb ausschließlich im Freien, mit Abstand zu Gebäuden, Zelten, Markisen und brennbarem Material.",
      "Rückgabe grob gereinigt und ausgekühlt, Asche entfernt – sonst berechnen wir eine Reinigungspauschale.",
      "Höhe ca. 2,20 m: Transport liegend, passender Anhänger optional mietbar.",
    ],
    tags: ["event", "catering", "gastronomie", "grill", "hochzeit"],
  },
  {
    id: "fritteuse-einzel-230v",
    name: "Einzelfritteuse 230 V, 8 l",
    description: "Elektrische Einzelfritteuse mit 8 l Becken für Imbiss, Vereinsfest und Catering – bis 190 °C, Ölablasshahn, 230 V.",
    detailedDescription:
      "Die elektrische Einzelfritteuse mit 8 Litern Fassungsvermögen im Frittierbecken eignet sich für Vereinsfeste, Imbissstände, Foodtrucks und Cateringküchen. Der Temperaturbereich reicht bis 190 °C; von 130 auf 180 °C heizt das Gerät in rund 3 Minuten auf, 800 g gefrorene Pommes frites sind in etwa 5 Minuten frittiert. Alle Lebensmittelkontaktteile bestehen aus 18/10-Edelstahl. Ein Sicherheitsthermostat, ein abnehmbares Bedienfeld und ein Ölablasshahn machen Betrieb und Reinigung unkompliziert. Das Tischgerät misst 29,5 × 54,5 × 42,7 cm (B × L × H) bei 8,75 kg Gewicht und lässt sich auf jeder stabilen, hitzebeständigen Arbeitsfläche aufstellen. Betrieben wird die Fritteuse an einer normalen 230-V-Schuko-Steckdose. Verfügbarkeit und Termine stimmen wir telefonisch oder per Anfrage mit dir ab.",
    category: "fritteuse",
    onRequest: true,
    pricePerDay: "ab 10 €",
    images: [
      "/product-images/fritteuse-einzel-8l-a.jpeg",
      "/product-images/fritteuse-einzel-8l-b.jpeg",
      "/product-images/fritteuse-einzel-8l-c.jpeg",
      "/product-images/fritteuse-einzel-8l-d.jpeg",
      "/product-images/fritteuse-einzel-8l-e.jpeg",
    ],
    image: "/product-images/fritteuse-einzel-8l-a.jpeg",
    imageAlts: [
      "Einzelfritteuse 230 V mit 8 l Becken und Frittierkorb mieten bei SLT Rental",
      "Einzelfritteuse mieten – Bedienfeld mit Temperaturregler bis 190 °C und Kontrollleuchten",
      "Einzelfritteuse 8 l – Edelstahlgehäuse als Tischgerät für Imbiss und Catering",
      "Frittierbecken aus 18/10-Edelstahl der gemieteten Einzelfritteuse",
      "Pommes frites im Frittierkorb einer gemieteten Einzelfritteuse von SLT Rental",
    ],
    specifications: {
      "Bauart": "Einzelfritteuse (Tischgerät)",
      "Becken": "1 Frittierbecken",
      "Fassungsvermögen": "8 l",
      "Temperaturbereich": "bis 190 °C",
      "Aufheizzeit": "ca. 3 Min. (130 → 180 °C)",
      "Material": "Lebensmittelkontaktteile aus 18/10-Edelstahl",
      "Ausstattung": "Sicherheitsthermostat, abnehmbares Bedienfeld, Ölablasshahn",
      "Stromanschluss": "230 V (Schuko)",
      "Abmessungen (B × L × H)": "29,5 × 54,5 × 42,7 cm",
      "Gewicht": "8,75 kg",
    },
    features: [
      "8 l Frittierbecken – ca. 800 g Pommes frites in rund 5 Minuten",
      "Schnelle Aufheizzeit: ca. 3 Minuten von 130 auf 180 °C",
      "Lebensmittelkontaktteile aus 18/10-Edelstahl",
      "Ölablasshahn und abnehmbares Bedienfeld für einfache Reinigung",
      "Sicherheitsthermostat",
      "230-V-Betrieb – kein Starkstrom nötig",
    ],
    rentalNotes: [
      "Frittierfett bzw. -öl wird nicht mitvermietet und ist selbst mitzubringen.",
      "Rückgabe bitte entleert und grob gereinigt – andernfalls berechnen wir eine Reinigungspauschale.",
      "Altöl bitte fachgerecht entsorgen, nicht im Gerät belassen.",
    ],
    tags: ["event", "catering", "gastronomie", "imbiss", "fritteuse"],
  },

  {
    id: "fritteuse-doppel-230v",
    name: "Doppelfritteuse 230 V",
    description: "Elektrische Doppelfritteuse mit 2 Becken und 16 l Gesamtvolumen für Imbiss, Vereinsfest und Catering – mechanische Steuerung, 30–190 °C, 230 V.",
    detailedDescription:
      "Die Doppelfritteuse mit zwei getrennten Frittierbecken und 16 Litern Gesamtfassungsvermögen eignet sich für Vereinsfeste, Imbissstände, Foodtrucks und Cateringküchen. Zwei Becken bedeuten getrennte Fettbäder – zum Beispiel Pommes im einen und panierte Produkte oder vegetarische Ware im anderen Becken. Die Temperatur wird mechanisch von 30 bis 190 °C eingestellt, eine Temperaturanzeige zeigt den aktuellen Wert. Das Gerät ist ein Tischmodell (39 × 55 × 55,8 cm, 13,75 kg) und lässt sich auf jeder stabilen, hitzebeständigen Arbeitsfläche aufstellen. Die Gesamtleistung von 6.500 W verteilt sich auf beide Becken; die Fritteuse wird mit 220–240 V betrieben. Plane die Stromversorgung so, dass beide Becken auf getrennt abgesicherten Stromkreisen laufen – sonst löst bei gleichzeitigem Aufheizen die Sicherung aus. Verfügbarkeit und Termine stimmen wir telefonisch oder per Anfrage mit dir ab.",
    category: "fritteuse",
    onRequest: true,
    pricePerDay: "ab 10 €",
    images: [
      "/product-images/fritteuse-doppel-230v-1.jpeg",
      "/product-images/fritteuse-doppel-230v-2.jpeg",
      "/product-images/fritteuse-doppel-230v-3.jpeg",
      "/product-images/fritteuse-doppel-230v-4.jpeg",
      "/product-images/fritteuse-doppel-230v-5.jpeg",
    ],
    image: "/product-images/fritteuse-doppel-230v-1.jpeg",
    imageAlts: [
      "Doppelfritteuse 230 V mit zwei Frittierbecken und Korbgriffen mieten bei SLT Rental",
      "Doppelfritteuse mieten – Bedienfeld mit mechanischem Temperaturregler 30–190 °C",
      "Doppelfritteuse 16 l – zwei getrennte Frittierbecken mit herausnehmbaren Körben",
      "Doppelfritteuse 230 V – Edelstahlgehäuse als Tischgerät für Imbiss und Catering",
      "Pommes frites im Frittierkorb einer gemieteten Doppelfritteuse von SLT Rental",
    ],
    specifications: {
      "Bauart": "Doppelfritteuse (Tischgerät)",
      "Becken": "2 Frittierbecken",
      "Fassungsvermögen": "16 l gesamt",
      "Leistung": "6.500 W",
      "Spannung": "220–240 V",
      "Temperaturbereich": "30–190 °C",
      "Bedienfeld": "mechanisch, mit Temperaturanzeige",
      "Abmessungen (H × B × T)": "39 × 55 × 55,8 cm",
      "Gewicht": "13,75 kg",
    },
    features: [
      "Zwei getrennte Frittierbecken für paralleles Frittieren",
      "16 l Gesamtfassungsvermögen",
      "Mechanische Temperatursteuerung 30–190 °C mit Anzeige",
      "Kompaktes Tischgerät (39 × 55 × 55,8 cm, 13,75 kg)",
      "230-V-Betrieb – kein Starkstrom nötig",
    ],
    rentalNotes: [
      "Frittierfett bzw. -öl wird nicht mitvermietet und ist selbst mitzubringen.",
      "Rückgabe bitte entleert und grob gereinigt – andernfalls berechnen wir eine Reinigungspauschale.",
      "Beide Becken zusammen ziehen bis 6.500 W: nach Möglichkeit zwei getrennt abgesicherte Stromkreise nutzen.",
    ],
    tags: ["event", "catering", "gastronomie", "imbiss", "fritteuse"],
  },
  {
