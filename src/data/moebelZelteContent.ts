...
const sizeTable = {
  ...
  rows: [
    ...
    ["Größere Feier (50–70 Pers.)", "40–48 m²", "Party- / Eventzelt 4×10 oder Party- / Eventzelt 6×8"],
    ["Hochzeit / Vereinsfest (80–120 Pers.)", "56–72 m²", "Party- / Eventzelt 4×14 oder Party- / Eventzelt 6×12"],
  ],
};
...
export const moebelZelteContent: Record<string, MoebelZelteContent> = {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Typische Konstellation für ein Bauernschützenfest in Krefeld-Oppum oder Linn: drei bis vier Bierzeltgarnituren mit Hussen unter einem Party- / Eventzelt 6×12 m, dazu ein Getränkekühlschrank mit Glastür für die Theke und ein paar Stehtische am Eingang. Praktisch ist die Bierzeltgarnitur auch als Buffettisch: zwei Garnituren parallel gestellt ergeben eine 4,4 m lange Buffetzeile, die mit weißer Tischhusse sofort nach Catering aussieht.",
          "Preise Bierzeltgarnitur Krefeld: Ein komplettes Set (Tisch + zwei Bänke) gibt es bereits ab 8 € pro Tag, ein ganzes Wochenende (Freitag bis Montag) ab 15 € pro Set – ideal für Schützenfeste, Hochzeiten und Vereinsfeiern. Die finalen Mietpreise je nach Anzahl, Mietdauer und Hussen-Option sehen Sie transparent im Buchungsschritt; auf alle Sätze greift unsere Tiefpreisgarantie.",
        ],
      },
      {
        h2: "Party- / Eventzelte mit 2,6 m Durchgangshöhe – wenn es repräsentativer werden soll",
        paragraphs: [
          "Für Hochzeiten, Firmenjubiläen oder Karnevalssitzungen empfehlen wir die Party- / Eventzelte 6×8 m (48 m²) und 6×12 m (72 m²). Beide bieten 2,6 m lichte Durchgangshöhe – das wirkt deutlich großzügiger als ein klassisches Party- / Eventzelt und lässt Stehtische, Sektempfang und Live-Band ohne gefühlte Decke über dem Kopf zu. Im Lieferumfang sind Seiten- und Stirnwände enthalten.",
          "Das Party- / Eventzelt 6×12 m ist zusätzlich nach EN 13501-1 schwer entflammbar zertifiziert. Damit eignet es sich für Veranstaltungen mit erhöhten Brandschutzauflagen, etwa bei Vereinsjubiläen mit größerer Personenzahl oder Firmenevents auf gemieteten Außenflächen in Krefeld-Fichtenhain.",
        ],
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Für klassische Schützen- und Vereinsfeste mit 60 bis 100 Personen empfehlen wir das Party- / Eventzelt 6×12 m (72 m², 2,6 m Durchgangshöhe, schwer entflammbar nach EN 13501-1) in Kombination mit Bierzeltgarnitur-Sets. Für kleinere Vereinsabende reicht ein Party- / Eventzelt 4×8 oder das modulare 4×10.",
      },
      {
        question: "Welche Zeltgrößen sind in Krefeld verfügbar?",
        answer:
          "Wir vermieten Party- / Eventzelte in 9, 16, 24, 32, 40 und 56 m² sowie Party- / Eventzelte mit 48 m² (6×8) und 72 m² (6×12). Damit decken wir Anlässe vom Garten-Geburtstag bis zum Vereinsjubiläum mit über 100 Gästen ab.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Das Party- / Eventzelt 6×12 m ist nach EN 13501-1 schwer entflammbar zertifiziert. Bei den weiteren Zelten teilen wir die jeweils gültige Brandschutz-Klassifizierung gerne auf Anfrage mit, damit Sie die Vorgaben des Veranstaltungsorts oder Ordnungsamts einhalten.",
      },
      {
  ...
  bonn: {
    ...
    metaDescription:
      "Party- / Eventzelte, Bierzeltgarnituren mit Hussen und Stehtische mieten in Bonn. Für Gartenhochzeit, Sommerfest und Empfang – B2B-Konditionen verfügbar. Jetzt anfragen.",
    keywords:
      "Möbel und Zelte mieten Bonn, Party- / Eventzelt mieten Bonn, Hochzeitszelt mieten Bonn, Party- / Eventzelt mieten Bonn, Bierzeltgarnitur mieten Bonn, Bierzeltgarnitur Set mieten Bonn, Bierzeltgarnitur mit Hussen Bonn, Festzeltgarnitur mieten Bonn, Bierbankgarnitur mieten Bonn, Biertische und Bänke mieten Bonn, Stehtisch mieten Bonn, Stehtisch mit Husse mieten Bonn, Bistrotisch mieten Bonn, Cocktailtisch mieten Bonn, Mietmöbel Bonn, Zeltverleih Bonn, Tische und Stühle mieten Bonn",
    heroLead:
      "Ob Gartenhochzeit in Bad Godesberg, Sommerfest einer Bundesbehörde am Rhein oder Sektempfang in Endenich: Über die Filiale in Bonn bekommen Sie bei SLT Rental das passende Equipment für repräsentative wie private Anlässe. Vom 6×8 m Party- / Eventzelt mit 2,6 m Durchgangshöhe über Bierzeltgarnituren mit weißen Hussen bis hin zu Stehtischen, Stapelstühlen und Sonnenschirmen – im Rheinland aus einer Hand mietbar.",
    bottomHeadline: "Möbel und Zelte mieten in Bonn – Eventausstattung für Rhein und Vorgebirge",
    sections: [
      {
        h2: "Party- / Eventzelte mit 2,6 m Durchgangshöhe – die Basis für Hochzeit und Empfang",
        paragraphs: [
          "Das Party- / Eventzelt 6×8 m (48 m²) ist die Standardlösung für Gartenhochzeiten in Bad Godesberg, Beuel oder Endenich. Mit 2,6 m lichter Durchgangshöhe und kompletten Seiten- und Stirnwänden lässt es genug Raum für Tafeltische, eine kleine Tanzfläche und einen DJ-Bereich. Für größere Feiern mit 80 bis 120 Gästen liefern wir das Party- / Eventzelt 6×12 m (72 m²), nach EN 13501-1 schwer entflammbar zertifiziert.",
          "Beispielszene: Sektempfang im Garten in Bad Godesberg mit acht Stehtischen unter weißen Stretch-Hussen, anschließend Hochzeitsdinner unter dem 6×8 m Party- / Eventzelt mit Bierzeltgarnituren in der weißen Hussen-Variante – funktional, aber durchaus elegant.",
        ],
      },
      {
        h2: "Bierzeltgarnitur mieten in Bonn – das Rückgrat jeder Feier im Rheinland",
        paragraphs: [
          "Ein Bierzeltgarnitur-Set – auch als Festzeltgarnitur, Bierbankgarnitur oder einfach Biertisch mit Bänken bekannt – besteht bei uns aus einem klappbaren Tisch (50 × 220 cm) und zwei Bänken (25 × 220 cm). Pro Garnitur rechnen Sie mit acht bis zehn Sitzplätzen. Das ergibt für eine klassische Hochzeit mit 60 Gästen rund sieben bis acht Bierzeltgarnituren – aufgebaut in U-Form unter dem Party- / Eventzelt 6×8 m oder in Reihen für eine Tafel-Optik.",
          ...
          "Preise Bierzeltgarnitur Bonn: Ein komplettes Set (Tisch + zwei Bänke) ist bereits ab 8 € pro Tag verfügbar, ein ganzes Wochenende (Freitag bis Montag) ab 15 € pro Set – attraktiv für Sommerfeste, Hochzeiten in Bad Godesberg und Veranstaltungen am Rhein. Die genauen Mietpreise je nach Stückzahl, Mietdauer und optionalem Hussen-Set sehen Sie transparent im Buchungsschritt; Tiefpreisgarantie inklusive.",
        ],
      },
      {
        h2: "Welche Zeltgröße passt zu welchem Anlass?",
        paragraphs: [
          "Faustformel: 0,8 bis 1,0 m² pro sitzender Person, mit Tanzfläche und Buffet eher 1,5 m². Eine Hochzeit mit 60 Gästen sitzt komfortabel im Party- / Eventzelt 6×8 m, eine Firmenfeier mit 100 Personen passt unter das Party- / Eventzelt 6×12 m. Für kleine Gartenrunden reichen die Party- / Eventzelte 3×3 bis 4×8.",
        ],
        table: sizeTable,
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Für Gartenhochzeiten in Bad Godesberg, Beuel oder Endenich empfehlen wir das Party- / Eventzelt 6×8 m (48 m², 2,6 m Durchgangshöhe). Für 80 bis 120 Gäste das Party- / Eventzelt 6×12 m mit 72 m² – schwer entflammbar nach EN 13501-1.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Verfügbar sind Party- / Eventzelte mit 9, 16, 24, 32, 40 und 56 m² Grundfläche sowie Party- / Eventzelte mit 48 m² (6×8) und 72 m² (6×12). Damit decken wir Anlässe von der Gartenfeier bis zum Bundesbehörden-Sommerfest ab.",
      },
      {
      ...
      {
        question: "Sind die Party- / Eventzelte feuerfest?",
        answer:
          "Das Party- / Eventzelt 6×12 m ist nach EN 13501-1 schwer entflammbar zertifiziert. Für die übrigen Zelte erhalten Sie die jeweils gültige Brandschutz-Klassifizierung auf Anfrage – wichtig, falls die Veranstaltungsfläche entsprechende Auflagen vorsieht.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Preise Bierzeltgarnitur Mülheim an der Ruhr: Ein komplettes Set (Tisch + zwei Bänke) startet ab 8 € pro Tag, ein ganzes Wochenende (Freitag bis Montag) ab 15 € pro Set – passend für Vereinsjubiläen in Saarn, Hochzeiten am Schloss Broich und Industrie-Events im westlichen Ruhrgebiet. Endgültige Mietpreise je nach Anzahl, Mietdauer und Hussen-Option erscheinen transparent im Buchungsschritt; Tiefpreisgarantie greift auf alle Sätze.",
        ],
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Für Gartenfeiern in Saarn, Mintard oder Speldorf empfehlen wir die modularen Party- / Eventzelte 4×10 m oder 4×14 m – sie passen sich verwinkelten Grundstücken an. Bei repräsentativeren Anlässen das Party- / Eventzelt 6×8 m mit 2,6 m Durchgangshöhe.",
      },
      {
        question: "Welche Zeltgrößen sind in Mülheim an der Ruhr verfügbar?",
        answer:
          "Verfügbar sind Party- / Eventzelte mit 9, 16, 24, 32, 40 und 56 m² sowie Party- / Eventzelte mit 48 m² (6×8) und 72 m² (6×12). Damit lassen sich Geburtstage, Vereinsfeste und Hochzeiten unterschiedlicher Größenordnung im westlichen Ruhrgebiet abdecken.",
      },
      {
      ...
      },
      {
        question: "Sind die Party- / Eventzelte feuerfest?",
        answer:
          "Das Party- / Eventzelt 6×12 m ist nach EN 13501-1 schwer entflammbar zertifiziert. Bei den weiteren Zelten teilen wir die jeweils gültige Brandschutz-Klassifizierung auf Anfrage mit – relevant, falls der Veranstaltungsort entsprechende Auflagen vorsieht.",
      },
      {
