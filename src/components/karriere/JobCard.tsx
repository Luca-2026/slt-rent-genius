        ...
        <CollapsibleContent>
          <CardContent className="pt-0 border-t border-border">
            ...
            <div className="py-6 space-y-6">
              <div>
                <h4 className="font-semibold text-foreground mb-3">Stellenbeschreibung</h4>
              ...
              {/* Requirements */}
              <div>
                <h4 className="font-semibold text-foreground mb-3">Anforderungen</h4>
              ...
              {/* Benefits */}
              <div>
                <h4 className="font-semibold text-foreground mb-3">Wir bieten</h4>
                <ul className="space-y-2">
