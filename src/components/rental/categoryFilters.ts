...
export const werkzeugeFilterSections: FilterSection[] = [
  {
    ...
    options: [
      ...
      { id: "schrauber", label: "catFilters.schrauber", sublabel: "catFilters.schrauber_sub" },
      ...
      { id: "schneiden", label: "catFilters.schneiden_werkzeug", sublabel: "catFilters.schneiden_werkzeug_sub" },
      ...
      { id: "beleuchtung", label: "catFilters.beleuchtung_werkzeug", sublabel: "catFilters.beleuchtung_werkzeug_sub" },
