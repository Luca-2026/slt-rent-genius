          ...
          {services.map((service, index) => (
            <AnimatedSection key={service.title} delay={index * 100} animation="fade-in-up">
              <Link to={service.link}>
                <Card className="h-full group hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/30 cursor-pointer">
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <h3 className="font-bold text-headline mb-2 group-hover:text-primary transition-colors">
                      {service.title}
                    </h3>
