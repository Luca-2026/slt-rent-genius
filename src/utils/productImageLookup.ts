...
["cee-adapter-schuko-16a-1", "netzwerkkabel-cat7-30m-1", "powercon-true1-linkkabel-5m-1", "anschlussverteilerschrank-24kva-1", "anschlussverteilerschrank-24kva-2", "anschlussverteilerschrank-24kva-3", "cee-kabel-63a-5m-1", "powercon-linkkabel-1-5m-1", "cee-adapter-16a-32a-1", "titanex-powercon-true1-5m-1", "cee-63a-uv-2x32a-2x16a-1", "office-kabelbruecke-2m-1", "office-kabelbruecke-2m-2", "netzwerkkabel-cat5e-20m-1", "schukokabel-20m-1", "hdmi-glasfaser-35m-1", "ethercon-cat5e-20m-1", "titanex-powercon-true1-10m-1", "cee-kabel-16a-rot-5m-1", "cee-16a-uv-5x-schuko-1", "cee-kabel-32a-rot-5m-1", "cee-adapter-63a-32a-1"].forEach((f) => (IMAGE_DIR_MAP[f] = "kabel-stromverteiler"));
