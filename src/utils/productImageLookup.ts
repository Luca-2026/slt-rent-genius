...
["cee-adapter-schuko-16a-1", "netzwerkkabel-cat7-30m-1", "powercon-true1-linkkabel-5m-1", "anschlussverteilerschrank-24kva-1", "anschlussverteilerschrank-24kva-2", "anschlussverteilerschrank-24kva-3", "cee-kabel-63a-5m-1", "powercon-linkkabel-1-5m-1", "cee-adapter-16a-32a-1", "titanex-powercon-true1-5m-1"].forEach((f) => (IMAGE_DIR_MAP[f] = "kabel-stromverteiler"));
