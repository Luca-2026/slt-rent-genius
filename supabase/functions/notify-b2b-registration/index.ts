  ...
  <div style="max-width:600px;margin:0 auto;background:#ffffff;">
    ...
    <div style="padding:32px;">
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;">
        <tr>
          <td style="padding:8px 12px;border-bottom:1px solid #eee;color:#888;width:140px;">Unternehmen</td>
          <td style="padding:8px 12px;border-bottom:1px solid #eee;color:#1a1a1a;font-weight:600;">${companyDisplay}</td>
        </tr>
        <tr>
          <td style="padding:8px 12px;border-bottom:1px solid #eee;color:#888;">Ansprechpartner</td>
        ...
        <tr>
          <td style="padding:8px 12px;border-bottom:1px solid #eee;color:#888;">Ort</td>
          <td style="padding:8px 12px;border-bottom:1px solid #eee;color:#1a1a1a;">${postalCode} ${city}</td>
        </tr>
        <tr>
