...
export const RecoveryEmail = ({
  ...
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Passwort zurücksetzen – SLT Rental B2B-Portal</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            du hast angefordert, dein Passwort für das{' '}
            <Link href="https://www.slt-rental.de" style={linkStyle}>SLT Rental B2B-Portal</Link>{' '}
            zurückzusetzen. Klicke auf den folgenden Button, um ein neues Passwort zu wählen:
          </Text>
