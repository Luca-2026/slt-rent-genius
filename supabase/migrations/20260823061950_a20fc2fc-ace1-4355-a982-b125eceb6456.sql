...
SELECT id, slug, name, model_name, description, detailed_description, category, subcategory,
       ...
       rentware_code, on_request, pdf_url, external_manual_url, video_url, video_urls, sort_order,
       seo_meta_description, seo_faqs, seo_local_content, image_alts, price_unit_label,
       addon_options, created_at, updated_at
