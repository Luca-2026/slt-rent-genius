...
const planTotal = PLAN.toGenerateNew.length + PLAN.toOverwrite.length;
console.log(`Plan total:           ${planTotal} Produkte (A=${PLAN.toGenerateNew.length} neu, B=${PLAN.toOverwrite.length} cluster-overwrite)`);
